...
// Source File Name:   RelationInterface.java
...
public interface RelationInterface
{
	...
	public abstract void setName_class(String s);

	public abstract String getName_class();

	public abstract String getInverse();
}
