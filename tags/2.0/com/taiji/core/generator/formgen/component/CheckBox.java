...
public class CheckBox
{
	...
	public String toString()
	{
		...
		String staticValue = "²âÊÔÀý×Ó0:0|²âÊÔÀý×Ó1:1|²âÊÔÀý×Ó2:2|";
		String namevalue;
		int index;
		for (StringTokenizer st = new StringTokenizer(staticValue, "|"); st.hasMoreElements(); sb.append((new StringBuilder("<input type='checkbox'")).append(_element.getCommonExpress()).append(" value = ").append(namevalue.substring(index + 1)).append(">").append(namevalue.substring(0, index)).append("</input>").toString()))
		{
