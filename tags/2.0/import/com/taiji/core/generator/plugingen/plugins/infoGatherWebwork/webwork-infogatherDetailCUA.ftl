...
<body>
${r"<@ww.form"} name="'form'" action ="'checkAll${className}'" method="'post'" validate="'true'">
...
<table width="100%"><tbody>
	<tr height = "26">
		...
		<td>
			...
			${r"<@ww.hidden"} name ="'${objectName}Check.proposer'"/>
		</td>
		<td>业务申请时间</td>
		<td>
			${r"<@ww.textfield"} name="'${objectName}Check.applyTime'" cssClass="'inputTextLong'"   />
		</td>
	</tr>
 </tr>
 	<tr>
