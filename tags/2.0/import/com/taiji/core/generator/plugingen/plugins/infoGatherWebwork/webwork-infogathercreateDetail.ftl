...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabMainBot">
  <tr>
    <td>
      ...
      <input name="Button42" type="button" class="button" value="${r"${action.getText('return.text')}"}" onClick ="document.location.href='../infogather/listn${className}.action?funcCode=${r"${funcCode}"}&pageNum=${r"${pageNum}"}'">
    </td>
  </tr>
</table>
<br>
