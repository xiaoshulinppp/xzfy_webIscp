...
public class XzfyRecieve   {
  ...
  // fields
   ...
   private java.util.Date receive_real_date;
...
private java.lang.String condition_type;
   ...
   private java.util.Date lian_real_date;

   private java.util.Date finish_real_date;
...
public java.util.Date getReceive_real_date() {
	return receive_real_date;
}
public void setReceive_real_date(java.util.Date receiveRealDate) {
	receive_real_date = receiveRealDate;
}
...
public float getMoney_detail() {
	return money_detail;
}
public void setMoney_detail(float moneyDetail) {
...
public java.util.Date getLian_real_date() {
	return lian_real_date;
}
public void setLian_real_date(java.util.Date lianRealDate) {
	lian_real_date = lianRealDate;
}
public java.util.Date getFinish_real_date() {
	return finish_real_date;
}
public void setFinish_real_date(java.util.Date finishRealDate) {
...
private java.lang.String is_commit;
  ...
  // relations
	 ...
	 private Set xzfyLogs = new LinkedHashSet();
	...
	public void setApp_type2(java.lang.String appType2) {
		app_type2 = appType2;
	}
	...
	public Set<XzfyDftz> getXzfyDftzs() {
		return xzfyDftzs;
	}
	public void setXzfyDftzs(Set<XzfyDftz> xzfyDftzs) {
		this.xzfyDftzs = xzfyDftzs;
	}
	...
	public void setXzfyLogs(Set xzfyLogs) {
		this.xzfyLogs = xzfyLogs;
	}
	public Set getXzfyLogs() {
		return xzfyLogs;
	}
