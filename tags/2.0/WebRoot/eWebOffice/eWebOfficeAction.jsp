...
<%!public eWebOfficeServer EWEBOS = null;
	...
	private static String DBConnectionString = "jdbc:oracle:thin:@192.168.56.241:1521:orcl";
	private static String DBNAME = "eweb";
	private static String DBPASS = "eweb";
	...
	public void DoSaveFile() {
		int caseId = Integer.valueOf(EWEBOS.WebMsgGetString("CusParam"));
		String s_RecordID = EWEBOS.WebMsgGetString("RecordID");
