...
//eWebOffice1.WebMsgSetString("caseId","<%=ms_caseId%>");
...
function DoCheckSubmit() {
	...
	<body>
		<div id="bdy">
			...
			<div id="nav">
				您当前位置 &gt;&gt;
				<a href="default.jsp">eWebOffice示例首页</a> &gt;&gt; 文档编辑[
				<span class=red><%=ms_NodeDesc%></span>]
			</div>
			<hr />

			<form name="form1" method="post" action="document_save.jsp"
					...
					<tr>
						...
						<td width="50%" rowspan="2" align="center">
							...
							<input type=submit value="清稿" class="btn4"
								onclick="eWebOffice1.AcceptAllRevisions()">
							...
							<input type="button" class="btn4"
								onclick="location.href='default.jsp'" value="返回列表">
							<br>
							<br>
