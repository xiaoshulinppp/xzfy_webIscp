...
function DoCheckSubmit() {
	...
	<body>
		<div id="bdy">
			...
			<form name="form1" method="post" action="bac_document_buyushouligaozhishu_save.jsp"
...
function insertPicture1(){
	window.open("http://localhost:8080/webIscp/bac_default_buyushouligaozhishu.jsp");
}
