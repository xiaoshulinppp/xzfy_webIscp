		  		...
		  		<tr class="trcolor" id="" >      
				    ...
				    <td class="tdFormInput" width="30%" >	
					    ...
					    <select name="finishBreakType" id="jafs1"  style="display:none">
						  ...
						  -->
						<option value="5" <#if xzfyInfo.finishBreakType?exists && xzfyInfo.finishBreakType=="3" || xzfyInfo.finishBreakType=="2" || xzfyInfo.finishBreakType=="5">selected</#if> >撤回申请</option>
