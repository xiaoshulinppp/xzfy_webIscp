...
<body>
<form action="''" name="form2" id="form1" method="post" ENCTYPE="multipart/form-data">
<!--您的位置表格开始-->
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="yourPlace" id=control>
  <tr>
    <td height="20">您的位置：典型案例 -&gt; 典型案例设置</td>
  </tr>
</table>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabMainBot">
  <tr >
    <td>
        ...
        <a href ="../dxal/dxal_Setup.action?pNum=1&funcCode=${funcCode}">首页</a>
        <a href ="../dxal/dxal_Setup.action?pNum=${upPage}&funcCode=${funcCode}">上一页</a>	
        <a href ="../dxal/dxal_Setup.action?pNum=${downPage}&funcCode=${funcCode}">下一页</a>
        <a href ="../dxal/dxal_Setup.action?pNum=${totalPage}&funcCode=${funcCode}">末页</a>
        第
...
<script language="javascript">
			function gotoPage(){
				...
				if(inputPage > ${totalPage}){
					...
					window.location = "../dxal/dxal_Setup.action?funcCode=${funcCode}&pNum=" + inputPage + "";
				}
				return;
			}
</script> 
