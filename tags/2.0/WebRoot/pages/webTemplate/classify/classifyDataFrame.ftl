	...
	<head>
		...
		<script type="text/javascript">
			function setClassifyId(nodeId){
				var url = "../webTemplate/gotoTemplateFunction.action?funcCode=${funcCode}&classifyId=" + nodeId;
		...
		<frameset cols="260,*" border="3" framespacing="3" borderColor="#28746a" >
			<frame id="classifyTree" src="../webTemplate/showClassifyDataTree.action?funcCode=${funcCode}" frameborder="1" border="1" scrolling="yes" />
			<frame id="classifyData" src="../webTemplate/gotoTemplateFunction.action?funcCode=${funcCode}&classifyId=${classifyId?default(0)}" />
		</frameset>
	</head>
	<noframes>
		<body>
