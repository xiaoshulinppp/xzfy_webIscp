	...
	<head>
		...
		<script type="text/javascript">
			function setClassifyId(nodeId){
				var url = "../webTemplate/showClassifyRoleList.action?funcCode=${funcCode}&entityId=" + nodeId;
		...
		<frameset cols="260,*" border="3" framespacing="3" borderColor="#28746a" >
			...
			<frame id="classifyData" src="../webTemplate/showClassifyRoleList.action?funcCode=${funcCode}&entityId=${classifyId?default(0)}" />
		</frameset>
	</head>
	<noframes>
		<body>
