...
function savaToGetDoc(){
	...
	function getBuzhengtongzhi(){
		var url="http://localhost:8080/webIscp/bac_document_edit.jsp?action=new&d_filetype=doc&d_templateid=20131021111523&d_username=${admit_name}&caseId=${xzfyInfo.id}&d_type=补正通知";
		window.open(url);
	}
