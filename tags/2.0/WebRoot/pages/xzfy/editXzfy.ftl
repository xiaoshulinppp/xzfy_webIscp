...
<tr >
     <th  width="25%">接待日期：</th>
    <td  width="25%">
    <input name="xzfyReceive.receive_date" type="text"
     id="receivedate" class="inputTextNormal" ischeck="y"
    onClick="WdatePicker()" altname="接待日期" value="${xzfyReceive.receive_date?default('')}" readonly="readonly">
      </td>
    
    <th >接待地点：</th>
	    <td >
	    <input name="xzfyReceive.receive_address" type="text" id="place" class="inputTextNormal" value="${xzfyReceive.receive_address?default('')}" readonly="readonly">
	    </td>
  </tr>
 <#--
...
<input name="app_face.count_year" type="hidden" class="inputTextNormal" ischeck="y" value=${countYear}>
  ...
  -->
    <tr >
  	<th >接待人：</th>
    <td >
    <input name="xzfyReceive.admit1" id="admit" type="text" class="inputTextNormal" value="${xzfyReceive.admit1?default('')}" ischeck="y"  altname="接待人" readonly="readonly">    
   </td>
   <th >第二接待人：</th>
    <td >
    <input name="xzfyReceive.admit2" id="admit2" type="text" class="inputTextNormal" value="${xzfyReceive.admit2?default('')}" altname="第二接待人" readonly>    
   </td>   
    </tr>	
<tr >
    <th  >被接待人：</th>
    <td >
    <textarea name="xzfyReceive.jd_detail" type="text" class="textarea"  id="user" ischeck="y" altname="被接待人" style="overflow-y:visible;" readonly>${xzfyReceive.jd_detail?default('')}</textarea>
    </td>
    <th >接待人数：</th>
    <td ><input name="xzfyReceive.applicationsum" type="text"
     id="applicationsum" class="inputTextNormal required validate-digits" altname="接待人数" value="${xzfyReceive.applicationsum?default('')}" readonly>
   </td>  
  </tr>
     <tr  style="display:none">
   <th >多人复议：</th>
...
<input name="xzfyReceive.ismany" id="duoren_y" value="${xzfyReceive.ismany?default('')}">
  ...
  <tr >
    ...
    <input name="xzfyReceive.issafe" id="anquany_y"  value="是" onclick="setAqf(1)" type="radio" class="radio" checked >&nbsp;&nbsp;是
    <input name="xzfyReceive.issafe" id="anquany_n"  value="否" onclick="setAqf(2)" type="radio" class="radio" >&nbsp;&nbsp;否
    <span id="aqspan"  style="display:block">
	 <a href="javascript:setAqf(1)">添加</a><br>
	    <textarea name="xzfyReceive.safe_content" type="text" class="textarea"  id="aqcontent" altname="安全隐患" style="overflow-y:visible;" onchange="textCounter(this.form.comment,1000);">${xzfyReceive.safe_content?default('')}</textarea>
	</span>
    <#else>
    <input name="xzfyReceive.issafe" id="anquany_y"  value="是" onclick="setAqf(1)" type="radio" class="radio" >&nbsp;&nbsp;是
    <input name="xzfyReceive.issafe" id="anquany_n"  value="否" onclick="setAqf(2)" type="radio" class="radio" checked >&nbsp;&nbsp;否
...
<#if xzfyReceive.receive_type =="2" || xzfyReceive.receive_type=="3">
  <tr >
    ...
    <td  width="30%">
    <input name="xzfyReceive.laixin_name" type="text" class="inputTextNormal" 
    id="user" ischeck="y" altname="来信人姓名" value = "${xzfyReceive.laixin_name?default('')}" readonly>
    
    <th  width="20%">接收日期：</th>
    <td  width="30%">
    <input name="xzfyReceive.receive_date" type="text"
     id="receivedate" class="inputTextNormal" ischeck="y"
      onClick="WdatePicker()" altname="接收日期" value="${xzfyReceive.receive_date?default('')}" readonly>
      </td>
  </tr>
  <tr class="trwhite">
    <th >来信人通信地址：</th>
	    <td >
	    <input name="xzfyReceive.laixin_address" type="text" id="dlr1" class="inputTextNormal" value="${xzfyReceive.laixin_address?default('')}" readonly></td>
	    </td>
    <th >来信人邮编：</th>
    <td ><input name="xzfyReceive.laixin_post" type="text" id="handlesecond" ischeck="y" class="inputTextNormal" value="${xzfyReceive.laixin_post?default('')}" readonly></td>
    </tr>
  <tr class="trwhite">
    <th >来文编号：</th>
    <td ><input name="xzfyReceive.zhize" type="text" id="zhize" class="inputTextNormal" value="${xzfyReceive.zhize?default('')}" readonly></td>
    <th >来信人电话：</th>
    <td ><input name="xzfyReceive.laixin_tel" type="text" id="phone" ischeck="y" class="inputTextNormal" value="${xzfyReceive.laixin_tel?default('')}" readonly></td>
   ...
   <tr >
	   ...
	   <@ww.select  name="'xzfyReceive.app_type'" id="applicationtype" headerKey="''" headerValue=""  list="getDictMap('sqrlb')" value="'${xzfyReceive.app_type?default('')}'.toString()" />
	   ...
	   <th >申请人人数：</th>
    <td >
      <input name="xzfyReceive.renCount" id="rencount"  type="text" class="inputTextNormal" value="${xzfyReceive.renCount?default('')}" readonly>
    </td>
   </tr>
    <tr  id="shenqingren1">
  	<th >申请人：</th>
    <td  colspan=3>
    <#if xzfyReceive.app_type=="1">
     <textarea name="xzfyReceive.appdetail" type="text" class="textarea" id="shenqingren" ischeck="y" altname="申请人" readonly>${xzfyReceive.appdetail?default('')}</textarea>
    </#if>
    <#if xzfyReceive.app_type=="2">
     <textarea name="xzfyReceive.agentDetail" type="text" class="textarea" id="shenqingren" ischeck="y" altname="申请人" readonly>${xzfyReceive.agentDetail?default('')}</textarea>
    </#if>
   ...
   <#if xzfyReceive.dbrDetail?exists && xzfyReceive.dbrDetail?has_content>
	<tbody id="daibiaorendiv">
	    <tr > 
		    <th >代表人：</th>
		    <td  colspan=3>
    		<textarea name="xzfyReceive.dbrDetail" type="text" class="textarea"  id="deputy" ischeck="y" altname="代表人" style="overflow-y:visible;" readonly>${xzfyReceive.dbrDetail?default('')}</textarea>
		    </td>
	    </tr>
   	</tbody> 
   </#if>
...
<#if xzfyReceive.receive_type =="1">
  ...
  <tr >
   <th >是否有代理人：</th>
    <td >
    <@ww.select name="'xzfyReceive.agent'" id="isdlr" headerKey="''" headerValue=""  list="getDictMap('sfdlr')" value="'${xzfyReceive.agent?default('')}'.toString()" onchange="'checkdlr()'"/>
    <#--
    <select name="xzfyReceive.agent" id="isdlr" onclick="checkdlr()">
  ...
  <tr class="trwhite" id="jddlr" >
    <th >委托代理人姓名：</th>
    <td >
      <input name="xzfyReceive.agent_name" type="text" id="dlrname" class="inputTextNormal" altname="委托代理人姓名项" value="${xzfyReceive.agent_name?default('')}" readonly>
    </td>
    <th >是否有授权委托书：</th>
    <td >
      <@ww.select name="'xzfyReceive.proxy'" id="dlrsq" headerKey="'0'" headerValue="'--请选择--'"  list="getDictMap('sfwtsqs')" value="'${xzfyReceive.proxy?default('')}'.toString()" />
      <#--
	  <select name="xzfyReceive.proxy"  id="dlrsq" onchange="checkdlr1()" retSelect="1">
  ...
  <tr class="trwhite" id="jddlr" style="display:none">
    ...
    <th >是否有授权委托书：</th>
    <td >
      <@ww.select name="'xzfyReceive.proxy'" id="dlrsq" headerKey="'0'" headerValue="'--请选择--'"  list="getDictMap('sfwtsqs')" value="'${xzfyReceive.proxy?default('')}'.toString()" onchange="'checkdlr1()'"/>
      <#--
	  <select name="xzfyReceive.proxy"  id="dlrsq" onchange="checkdlr1()" retSelect="1">
	    <option value="0">----请选择----</option>
	    <option value="1">无委托</option>
  ...
  <tr class="trwhite" id="jddlr1">
    <th >委托时间：</th>
    <td >
     <input name="xzfyReceive.agent_date" type="input" id="wtsj" value="${xzfyReceive.agent_date?default('')}" readonly>
     <#--
    ...
    <th >地点：</th>
    <td >
    <input name="xzfyReceive.agent_address" type="text" id="wtdd"
    class="inputTextNormal" altname="地点" value="${xzfyReceive.agent_address?default('')}" readonly></td>
  </tr>
  <#else>
  <tr class="trwhite" id="jddlr1" style="display:none">
    ...
    <input name="xzfyReceive.agent_date" type="hidden" id="wtsj"></td>
    <th >地点：</th>
    <td >
    <input name="xzfyReceive.agent_address" type="text" id="wtdd"
...
<#if xzfyReceive.receive_type =="2" || xzfyReceive.receive_type=="3">
 <tr >
    <th >代理人：</th>
	<td ><input name="xzfyReceive.agent_name"  type="text" class="inputTextNormal" altname="代理人" value="${xzfyReceive.agent_name?default('')}" readonly></td>
	<th >&nbsp;</th>
	<td >&nbsp;</td>
   </tr>	
   <tr  id="jddlr2">
    <th >第三人：</th>
    <td ><input name="xzfyReceive.third" id="dsdlr1" type="text" class="inputTextNormal"  altname="第三人" value="${xzfyReceive.third?default('')}" readonly></td>
	<th >第三人代理人：</th>
	<td ><input name="xzfyReceive.third_agent" type="text" class="inputTextNormal"  altname="第三人代理人" value="${xzfyReceive.third_agent?default('')}" readonly></td>
   </tr>
  
  <tr >
   <th >多人复议：</th>
   <td > 
   <input type="radio" name="xzfyReceive.isMany" value="是" id="duoren_y" ischeck="y" altname="多人复议" <#if xzfyReceive.isMany=="是">checked</#if>>
   <label for="duoren_y">是 </label>
   <input type="radio" name="xzfyReceive.isMany" value="否" id="duoren_n" ischeck="y" altname="多人复议" <#if xzfyReceive.isMany=="否">checked</#if>>
   <label for="duoren_n">否</label></td>
   
   <th >复议机关：</th>
 
    <td >
	    <select name="xzfyReceive.xzfy_org" ischeck="y" altname="复议机关" class="selectStyleNormal" >
			
		  <option value="0" <#if xzfyReceive.xzfy_org=="0">selected</#if>>----请选择----</option>	  
		  <option value="2" <#if xzfyReceive.xzfy_org=="2">selected</#if>>县级政府</option>		  
		  <option value="3" <#if xzfyReceive.xzfy_org=="3">selected</#if>>县级政府的部门</option>	 
		  <option value="6" <#if xzfyReceive.xzfy_org=="6">selected</#if>>省部级行政机关</option>
		  <option value="7" <#if xzfyReceive.xzfy_org=="7">selected</#if>>省级政府的部门</option>
	    </select>
    </td>
  </tr>
</#if>
...
<tr >
   <th >被申请人种类：</th>
   <td  >
     <@ww.select name="'xzfyReceive.defendant_type'" id="beapptype"  headerKey="'0'" headerValue="'--请选择--'"  list="getDictMap('bsqrzl')" value="'${xzfyReceive.defendant_type?default('')}'.toString()" />
     <#--     
	   <select name="xzfyReceive.defendant_type" id="beapptype" ischeck="y"
   ...
   <th  width="25%">被申请人名称：</th>
   <td  style="display:block;" id="beappnametd" >   
     <input name="ssss" type="text" class="inputTextNormal" id="beappnameinput" altname="被申请人名称" value="${xzfyReceive.defendant_name?default('')}" readonly>
  <#--
...
<#if xzfyReceive.receive_type == "1">
  <tr  id="mingan">
    <th >是否行政不作为：</th>
    <td >
    <@ww.select  name="'xzfyReceive.ismanage'" id="requestrrr" headerKey="''" headerValue=""  list="getDictMap('sfbzw')" value="'${xzfyReceive.ismanage?default('')}'.toString()" />
...
<#if xzfyReceive.receive_type =="2" || xzfyReceive.receive_type=="3">
	<tr >
    <th >被复议的具体行为-名称：</th>
    <td ><input name="xzfyReceive.xwname" id="xingwei" type="text" ischeck="y" altname="被复议的具体行为-名称" class="inputTextNormal" value="${xzfyReceive.xwname?default('')}" readonly></td>
     <th >被复议的具体行为-案号：</th>
    <td ><input name="xzfyReceive.xwnum" type="text" id="annum" class="inputTextNormal" ischeck="y" value="${xzfyReceive.xwnum?default('')}" readonly></td>
  </tr>
   
     <tr >
     <th >行政复议请求：</th>
    <td   colspan=3>
      <textarea name="xzfyReceive.xzfy_requset_retail" id="xzfyqq1" type="text" class="textarea"   rowspan="5" altname="行政复议请求">${xzfyReceive.xzfy_requset_retail?default('')}</textarea></td>
    </tr>
</#if>
<#if xzfyReceive.receive_type == "1">
<tr >
    <th >该具体行政行为侵害&nbsp;&nbsp;&nbsp;&nbsp;<br>申请人何种合法权益：</th>
	    <td ><textarea name="xzfyReceive.break_right" id="quanyi" type="text" class="textarea"   readonly>${xzfyReceive.break_right?default('')}</textarea>
	    </td>   
   <th  >行政复议请求：
  </th>
   <td  >
   <#-- 
  <select name="xzfyReceive.xzfy_requset"
   ...
   -->
    <textarea name="xzfyReceive.xzfy_requset_retail" id="xzfyqq1" type="text"  style="overflow-y:visible;" class="textarea" altname="行政复议请求" readonly>${xzfyReceive.xzfy_requset_retail?default('')}</textarea>
  </td>
  </tr>
</#if>  
  <tr >
    <th >是否申请听证：</th>
    <td >
      <#if xzfyReceive.istingzheng?exists && xzfyReceive.istingzheng=="是">
	  <input type="radio" name="xzfyReceive.istingzheng" value="是" id="tingzheng_y" ischeck="y" altname="是否听证" checked> 
	  <label for="isting_y">是</label>
	  <input type="radio" name="xzfyReceive.istingzheng" value="否" id="tingzheng_n" ischeck="y" altname="是否听证">
    ...
    <td  >
      <#if xzfyReceive.isMoney?exists && xzfyReceive.isMoney=="是">
	   <input type="radio" name="xzfyReceive.isMoney" value="是" id="peichang_y" ischeck="y" altname="是否行政赔偿" onclick="check_pc(1)" checked>
	   <label for="peichang_y">是</label>
	   <input type="radio" name="xzfyReceive.isMoney" value="否" id="peichang_n" ischeck="y" altname="是否行政赔偿" onclick="check_pc(2)" >
	   <label for="peichang_n">否</label>
	  <#else>
	   <input type="radio" name="xzfyReceive.isMoney" value="是" id="peichang_y" ischeck="y" altname="是否行政赔偿" onclick="check_pc(1)">
	   <label for="peichang_y">是</label>
	   <input type="radio" name="xzfyReceive.isMoney" value="否" id="peichang_n" ischeck="y" altname="是否行政赔偿" onclick="check_pc(2)" checked>
	   <label for="peichang_n">否</label>
	  </#if>
    </td>
   </tr>
  ...
  <tr  id="peichang_div">
	<th >赔偿金额：</th>
	<td >
	  <input type="text" name="xzfyReceive.money_Detail" id="peichang_count" value="${xzfyReceive.money_Detail?default('')}">
	</td>
	<th >受损证明材料：</th>
    <td  >
    <textarea name="xzfyReceive.money_file" id="peichang_file" class="textarea" style="overflow-y:visible;">${xzfyReceive.money_file?default('')}</textarea>
    </td>
  </tr>
  <#else>
  <tr  style="display:none" id="peichang_div">
	<th >赔偿金额：</th>
	<td >
	  <input type="text" name="xzfyReceive.money_Detail" id="peichang_count" value="">
	</td>
	<th >受损证明材料：</th>
    <td  >
    <textarea name="xzfyReceive.money_file" id="peichang_file" class="textarea" style="overflow-y:visible;"></textarea>
    </td>
  </tr>
  </#if>
	...
	<tr >
		<th >复议前置：</th>
	    <td >
	    <#if xzfyReceive.isfront?exists && xzfyReceive.isfront=="是">
		  <input type="radio" name="xzfyReceive.isfront" value="是" id="fyqz_y" ischeck="y" altname="复议前置" checked>
		  <label for="fyqz_y">是 </label>
		  <input type="radio" name="xzfyReceive.isfront" value="否" id="fyqz_n" ischeck="y" altname="复议前置">
	      <label for="fyqz_n">否</label>
	    <#else>
		  <input type="radio" name="xzfyReceive.isfront" value="是" id="fyqz_y" ischeck="y" altname="复议前置">
		  <label for="fyqz_y">是 </label>
		  <input type="radio" name="xzfyReceive.isfront" value="否" id="fyqz_n" ischeck="y" altname="复议前置" checked>
	      <label for="fyqz_n">否</label>
	    </#if>
        </td>
	    ...
	    <#if xzfyReceive.ischeck?exists && xzfyReceive.ischeck=="是">
	      <input type="radio" name="xzfyReceive.ischeck" nbzcheck="y" altname="对规范性文件审查" value="是" id="gfsc_y"  checked>
	      <label for="gfsc_y">是 </label>
	      <input type="radio" name="xzfyReceive.ischeck" altname="对规范性文件审查" value="否" nbzcheck="y" id="gfsc_n"  >
	      <label for="gfsc_n">否</label>
		  <span id="shencha">规范文件：
	      <input name="xzfyReceive.check_file" type="text" id="post2" class="inputTextNormal" value="${xzfyReceive.check_file?default('')}"></span>
	    <#else>
	      <input type="radio" name="xzfyReceive.ischeck" nbzcheck="y" altname="对规范性文件审查" value="是" id="gfsc_y" >
	      <label for="gfsc_y">是 </label>
	      <input type="radio" name="xzfyReceive.ischeck" altname="对规范性文件审查" value="否" nbzcheck="y" id="gfsc_n" checked>
	      <label for="gfsc_n">否</label>
		  <span id="shencha" style="display:none">规范文件：
	      <input name="xzfyReceive.check_file" type="text" id="post2" class="inputTextNormal" ></span>
	    </#if>
	    </td>
 ...
 <#if xzfyReceive.receive_type == "1">
  <tr >
  		...
  		<th >是否愿意接受调解：</th>
    <td >
    <@ww.select name="'xzfyReceive.istiaojie'" id="tiaojie" headerKey="''" headerValue="" value="'${xzfyReceive.istiaojie?default('')}'.toString()" list="getDictMap('sftj')" />
        <#--
        <select name="xzfyReceive.istiaojie" id="tiaojie"  onChange="showTiaojie();;closeBzw1()">
    ...
    <td >
    <@ww.select name="'xzfyReceive.issame'" id="isshouli" headerKey="''" headerValue=""  list="getDictMap('sfslfysq')" value="'${xzfyReceive.issame?default('')}'.toString()" />
    <#--
    <select name="xzfyReceive.issame" id="isshouli">
    <option value="否">否</option>
    <option value="是">是</option>
    </select>-->
    <textarea name="xzfyReceive.issame_detail" id="shuoming" style="overflow-y:visible;" altname="说明">${xzfyReceive.issame_detail?default('')}</textarea>
    </td>
</tr>
<#if xzfyReceive.istiaojie?exists && xzfyReceive.istiaojie=="1">
  <tbody id="otherDetail">	  
	  <tr  >
	    <td  colspan=4>调解日期自：
	    <input name="xzfyReceive.tiaojie_from" id="addbegin" type="text" onClick="WdatePicker()" size='10'  value="${xzfyReceive.tiaojie_from?default('')}">
	    至：
	    <input name="xzfyReceive.tiaojie_to" id="addend1" type="text"  onClick="WdatePicker()" size='10' value="${xzfyReceive.tiaojie_to?default('')}">
	    我们将于收到申请材料后<input name="xzfyReceive.tiaojie_count" type="text" id="tiaojieDate" size=2 value="${xzfyReceive.tiaojie_count?default('')}">个工作日内尝试案前调解工作，调解期间不计入行政复议受理审查或者行政复议审理期限。
	      </td>
...
<#else>
  <tbody id="otherDetail" style="display:none">	  
	  <tr  >
	    <td  colspan=4>调解日期自：
	    <input name="xzfyReceive.tiaojie_from" id="addbegin" type="text" onClick="WdatePicker()" size='10'  value="">
	    至：
	    <input name="xzfyReceive.tiaojie_to" id="addend1" type="text"  onClick="WdatePicker()" size='10'>
	    我们将于收到申请材料后<input name="xzfyReceive.tiaojie_count" type="text" id="tiaojieDate" size=2>个工作日内尝试案前调解工作，调解期间不计入行政复议受理审查或者行政复议审理期限。
	      </td>
 	 </tr>
  </tbody>
</#if>
 ...
 <tr >
  <th >接待情况：</th>
  <td  ><textarea name="xzfyReceive.jd_file_content" id="filedetail" type="text" class='textarea' style="overflow-y:visible;display:block" readonly>${xzfyReceive.jd_file_content?default('')}</textarea></td>
  <#--
    <td  >
    <@ww.select name="'xzfyReceive.condition_type'" id="handle" headerKey="'0'" headerValue="'--请选择--'"  list="getDictMap('jdqk')" value="'${xzfyReceive.condition_type?default('')}'.toString()" onchange="'check_remark()'"/>
    
	<select name="xzfyReceive.condition_type" id='handle'  onchange="check_remark()">
        <option value="0">----请选择----</option>
    ...
    <#if xzfyReceive.condition_type?exists>
    <#if  xzfyReceive.condition_type=="3">
    <a href="javascript:updateFile()" style="display:none" id="filespan">接收材料</a>
 
    <#elseif xzfyReceive.condition_type=="1">
    <textarea name="xzfyReceive.jd_gz_content" id="handle_detail" type="text" class='textarea' style="overflow-y:visible;display:none">${xzfyReceive.jd_gz_content?default('')}</textarea>
    <a href="javascript:setAdvice()" style="display:none" id="advicespan">添加意见</a>
    <#elseif xzfyReceive.condition_type=="2">
    <a href="javascript:setBuzheng()" style="display:none" id="bzspan">添加补正内容</a>
	<textarea name="xzfyReceive.jd_bz_content" id="bznr"  style="display:none;" type="text" class="textarea" style="overflow-y:visible;">${xzfyReceive.jd_bz_content?default('')}
	</textarea>
    </#if>
    <#else>
    <textarea name="xzfyReceive.jd_file_content" id="filedetail" type="text" class='textarea' style="overflow-y:visible;display:none"></textarea>
    </#if>
	</td> 
 -->
 <th >被接待人意见：</th>
    ...
    <textarea name="xzfyReceive.app_advice_detail" id="otheradvice" class="textarea" style="overflow-y:visible;" altname="意见" readonly>${xzfyReceive.app_advice_detail?default('')}</textarea>
    </td>
 </tr>
 	<!--
	 ...
	 <td >&nbsp;</td>
	 <td >&nbsp;</td>
	 <td ><span style="display:none;" id="senddept">转送机构名称：</span></td>
	 ...
	 <th >是否游行示威：</th>
	 <td > 
	 <#if xzfyReceive.TPoliceIsparade?exists && xzfyReceive.TPoliceIsparade == "1">
	  <input type="radio" name="xzfyReceive.TPoliceIsparade"  value="1" id="yxsw_y" altname="是否游行示威" checked>
      <label for="xzpc_y">是 </label>
      <input type="radio" name="xzfyReceive.TPoliceIsparade"  value="0" id="yxsw_n" altname="是否游行示威" >
      <label for="xzpc_n">否</label>
	 <#else>
	  <input type="radio" name="xzfyReceive.TPoliceIsparade"  value="1" id="yxsw_y" altname="是否游行示威" >
      <label for="xzpc_y">是 </label>
      <input type="radio" name="xzfyReceive.TPoliceIsparade"  value="0" id="yxsw_n" altname="是否游行示威" checked>
      <label for="xzpc_n">否</label>
	 </#if>
     </td>
	 <td >&nbsp;</td>
...
<input name="xzfyReceive.menu" type="hidden" id="menuSave">
<tbody id="jdcl1" style="display:none;">
 <tr >
  	<td >接待处理：</td>
    <td >
	当面及电话接待口头告知&nbsp<input name="xzfyReceive.reception"  type="radio" altname="接待处理" value='1' onclick="dispose()"><br>
	书面告知补正&nbsp<input name="xzfyReceive.reception"  type="radio" altname="接待处理" value='2' onclick="dispose();setJDCL(2)"><br>
	接收复议申请材料&nbsp<input name="xzfyReceive.reception"  type="radio" altname="接待处理" value='3' onclick="dispose();setJDCL(3)"><br>
	
  </td>  
  <td  colspan="2">
  <span style="display:none" id="reception1">
  &nbsp告知、解释规定（申请复议有关知识）&nbsp<input name="xzfyReceive.reception2"  type="radio" altname="接待处理" value='1' onclick="setJDCL(21)"><br>
&nbsp告知补正（明确表述，补齐材料）&nbsp<input name="xzfyReceive.reception2"  type="radio" altname="接待处理" value='2'  onclick="setJDCL(22)"><br>
&nbsp告知因没有利害关系，不符合受理条件&nbsp<input name="xzfyReceive.reception2"  type="radio" altname="接待处理" value='3'  onclick="setJDCL(23)"><br>
&nbsp因其他机关已受理，或法院已受理，不符合受理条件&nbsp<input name="xzfyReceive.reception2"  type="radio" altname="接待处理" value='4'  onclick="setJDCL(24)"><br>
  &nbsp超过复议期限,不符合受理条件&nbsp<input name="xzfyReceive.reception2"  type="radio" altname="接待处理" value='5'  onclick="setJDCL(25)"><br>
  &nbsp不属于市政府职责范围，不符合受理条件&nbsp<input name="xzfyReceive.reception2"  type="radio" altname="接待处理" value='6'  onclick="setJDCL(26)"><br>
  &nbsp告知其他事项&nbsp<input name="xzfyReceive.reception2"  type="radio" altname="接待处理" value='7'  onclick="setJDCL(27)"><br>
  </span>
	  </td>
	</tr>
</tbody>
...
<div id="count1Div1" style="position:absolute;display:none;" class="diva">
 ...
 <tr>
	<td onmouseover="this.style.backgroundColor='#bfceff';sqfysx(1)"  height=40 onmouseout="this.style.backgroundColor='#ddecfb'">行政处罚&nbsp<input name="xzfyReceive.casetype"  type="radio" altname="申请复议事项" value='1' onclick="sqfysx(1)" id='sqfysx1'>
 ...
 <tr>
	...
	行政强制措施&nbsp<input name="xzfyReceive.casetype"  type="radio" altname="申请复议事项" value='2' onclick="sqfysx(2)" id='sqfysx2'><img src="../images/icon_work/icon_nextpage.gif" />
</td>
</tr>
 <tr>
	<td onmouseover="this.style.backgroundColor='#bfceff';sqfysx(3)" height=40  onmouseout="this.style.backgroundColor='#ddecfb'">
	行政征收&nbsp<input name="xzfyReceive.casetype"  type="radio" altname="申请复议事项" value='3' onclick="sqfysx(3)" id='sqfysx3'><img src="../images/icon_work/icon_nextpage.gif" />
</td>
</tr>
 <tr>
	...
	行政许可&nbsp<input name="xzfyReceive.casetype"  type="radio" altname="申请复议事项" value='4' onclick="sqfysx(0)" id='sqfysx4'><img src="../images/icon_work/icon_nextpage.gif" />
</td>
</tr>
 <tr>
	...
	行政确权&nbsp<input name="xzfyReceive.casetype"  type="radio" altname="申请复议事项" value='5' onclick="sqfysx(0)" id='sqfysx5'><img src="../images/icon_work/icon_nextpage.gif" />
</td>
</tr>
 <tr>
	...
	干预经营自主权&nbsp<input name="xzfyReceive.casetype"  type="radio" altname="申请复议事项" value='6' onclick="sqfysx(0)" id='sqfysx6'><img src="../images/icon_work/icon_nextpage.gif" />
</td>
</tr>
 <tr>
	...
	信息公开&nbsp<input name="xzfyReceive.casetype"  type="radio" altname="申请复议事项" value='7' onclick="sqfysx(0)" id='sqfysx7'><img src="../images/icon_work/icon_nextpage.gif" />
</td>
</tr>
 <tr>
	...
	行政不作为&nbsp<input name="xzfyReceive.casetype"  type="radio" altname="申请复议事项" value='8' onclick="sqfysx(0)" id='sqfysx8'><img src="../images/icon_work/icon_nextpage.gif" />
</td>
</tr>
 <tr>
	...
	其他&nbsp<input name="xzfyReceive.casetype"  type="radio" altname="申请复议事项" value='9' onclick="sqfysx(0)" id='sqfysx9'><img src="../images/icon_work/icon_nextpage.gif" />
	</td>
</tr>
	</td>
</table>
...
<tr >
	...
	拘留&nbsp<input name="xzfyReceive.casetype2"  type="radio" altname="申请复议事项" value='1' onclick="setSqfy2(1)" ><img src="../images/icon_work/icon_nextpage.gif" />
</td>
</tr>
<tr >
	...
	没收&nbsp<input name="xzfyReceive.casetype2"  type="radio" altname="申请复议事项" value='2' onclick="setSqfy2(2)"><img src="../images/icon_work/icon_nextpage.gif" />
</td>
</tr>
<tr >
	...
	罚款&nbsp<input name="xzfyReceive.casetype2"  type="radio" altname="申请复议事项" value='3' onclick="setSqfy2(3)"><img src="../images/icon_work/icon_nextpage.gif" />
</td>
</tr>
<tr >
	...
	其他&nbsp<input name="xzfyReceive.casetype2"  type="radio" altname="申请复议事项" value='4' onclick="setSqfy2(4)"><img src="../images/icon_work/icon_nextpage.gif" />
	</td>
</tr>
	</tbody>
...
<tr >
	...
	对人身的强制措施&nbsp<input name="xzfyReceive.casetype2"  type="radio" altname="申请复议事项" value='5' onclick="setSqfy2(5)"><img src="../images/icon_work/icon_nextpage.gif" />
</td>
</tr>
<tr >
	...
	对不动产的强制措施&nbsp<input name="xzfyReceive.casetype2"  type="radio" altname="申请复议事项" value='6' onclick="setSqfy2(6)"><img src="../images/icon_work/icon_nextpage.gif" />
</td>
</tr>
<tr >
	...
	对其它财产的强制措施&nbsp<input name="xzfyReceive.casetype2"  type="radio" altname="申请复议事项" value='7' onclick="setSqfy2(7)"><img src="../images/icon_work/icon_nextpage.gif" />
	</td>
</tr>
</tbody>
...
<tr>
	...
	征收土地&nbsp<input name="xzfyReceive.casetype2"  type="radio" altname="申请复议事项" value='8' onclick="setSqfy2(8)"><img src="../images/icon_work/icon_nextpage.gif" />
</td>
</tr>
<tr >
	...
	版税&nbsp<input name="xzfyReceive.casetype2"  type="radio" altname="申请复议事项" value='9' onclick="setSqfy2(9)"><img src="../images/icon_work/icon_nextpage.gif" />
</td>
</tr>
<tr >
	...
	收费&nbsp<input name="xzfyReceive.casetype2"  type="radio" altname="申请复议事项" value='10' onclick="setSqfy2(10)"><img src="../images/icon_work/icon_nextpage.gif" />
</td>
</tr>
<tr >
	...
	要求履行其他义务&nbsp<input name="xzfyReceive.casetype2"  type="radio" altname="申请复议事项" value='11' onclick="setSqfy2(11)"><img src="../images/icon_work/icon_nextpage.gif" />
	</td>
</tr>
</tbody>
	</table>
 ...
 <tr>
	...
	<input type="radio" name="xzfyReceive.refer" value="1"  id="1refer"><img src="../images/icon_work/icon_nextpage.gif" />
	</td>
</tr>
 <tr>
	...
	<input type="radio" name="xzfyReceive.refer" value="2"  id="2refer" onclick="closeKey1Div('count1Div1')">
	</td>
</tr>
 <tr>
	...
	<input type="radio" name="xzfyReceive.refer" value="3"  id="3refer">
	</td>
</tr>
 <tr>
	...
	<input type="radio" name="xzfyReceive.refer" value="4"  id="4refer" onclick="closeKey1Div('count1Div1')">
	</td>
</tr>
 <tr>
	...
	<input type="radio" name="xzfyReceive.refer" value="5"  id="5refer" onclick="closeKey1Div('count1Div1')">
	</td>
</tr>
 <tr>
	...
	<input type="radio" name="xzfyReceive.refer" value="6"  id="6refer"><img src="../images/icon_work/icon_nextpage.gif" />
	</td>
</tr>
 <tr>
	<td onmouseover="this.style.backgroundColor='#bfceff';setxz(7)" height=30 onmouseout="this.style.backgroundColor='#ddecfb'" >城建&nbsp
	<input type="radio" name="xzfyReceive.refer" value="7"  id="7refer"><img src="../images/icon_work/icon_nextpage.gif" />
	</td>
</tr>
 <tr>
	...
	<input type="radio" name="xzfyReceive.refer" value="8"  id="8refer"><img src="../images/icon_work/icon_nextpage.gif" />
	</td>
</tr>
 <tr>
	...
	<input type="radio" name="xzfyReceive.refer" value="9"  id="9refer"><img src="../images/icon_work/icon_nextpage.gif" />
	</td>
</tr>
 <tr>
	...
	<input type="radio" name="xzfyReceive.refer" value="10"  id="10refer"><img src="../images/icon_work/icon_nextpage.gif" />
	</td>
</tr>
 <tr>
	...
	<input type="radio" name="xzfyReceive.refer" value="11"  id="11refer" onclick="closeKey1Div('count1Div1')">
	</td>
</tr>
</table>
</td>
...
<tr >
	...
	治安<input type="radio" name="xzfyReceive.refer2" value="1" id="refer21" onclick="checkRefer2('1refer','refer21')">
</td>
</tr>
<tr >
	...
	劳教<input type="radio" name="xzfyReceive.refer2" value="2" id="refer22" onclick="checkRefer2('1refer','refer22')">
</td>
</tr>
<tr >
	...
	其他<input type="radio" name="xzfyReceive.refer2" value="3" id="refer23" onclick="checkRefer2('1refer','refer23')">
</td>
</tr>
</tbody>
...
<tr >
	...
	土地<input type="radio" name="xzfyReceive.refer2" value="9" id="refer29" onclick="checkRefer2('6refer','refer29')">
</td>
</tr>
<tr >
	...
	地矿<input type="radio" name="xzfyReceive.refer2" value="10" id="refer210" onclick="checkRefer2('6refer','refer210')">
</td>
</tr>
<tr >
	...
	环保<input type="radio" name="xzfyReceive.refer2" value="11" id="refer211" onclick="checkRefer2('6refer','refer211')">
</td>
</tr>
<tr >
	...
	农业<input type="radio" name="xzfyReceive.refer2" value="12" id="refer212" onclick="checkRefer2('6refer','refer212')">
</td>
</tr>
<tr >
	...
	水利<input type="radio" name="xzfyReceive.refer2" value="13" id="refer213" onclick="checkRefer2('6refer','refer213')">
</td>
</tr>
<tr >
	...
	林业<input type="radio" name="xzfyReceive.refer2" value="14" id="refer214" onclick="checkRefer2('6refer','refer214')">
</td>
</tr>
<tr >
	...
	其他<input type="radio" name="xzfyReceive.refer2" value="15" id="refer215" onclick="checkRefer2('6refer','refer215')">
</td>
</tr>
</tbody>
...
<tr >
	...
	规划<input type="radio" name="xzfyReceive.refer2" value="17" id="refer217" onclick="checkRefer2('7refer','refer217')">
</td>
</tr>
<tr >
	...
	拆迁<input type="radio" name="xzfyReceive.refer2" value="18" id="refer218" onclick="checkRefer2('7refer','refer218')">
</td>
</tr>
<tr >
	...
	房屋登记<input type="radio" name="xzfyReceive.refer2" value="19" id="refer219" onclick="checkRefer2('7refer','refer219')">
</td>
</tr>
<tr >
	...
	其他<input type="radio" name="xzfyReceive.refer2" value="20" id="refer220" onclick="checkRefer2('7refer','refer220')">
</td>
</tr>
</tbody>
...
<tr >
	...
	工商<input type="radio" name="xzfyReceive.refer2" value="22" id="refer222" onclick="checkRefer2('8refer','refer222')">
</td>
</tr>
<tr >
	...
	质监<input type="radio" name="xzfyReceive.refer2" value="23" id="refer223" onclick="checkRefer2('8refer','refer223')">
</td>
</tr>
<tr >
	...
	商务<input type="radio" name="xzfyReceive.refer2" value="24" id="refer224" onclick="checkRefer2('8refer','refer224')">
</td>
</tr>
<tr >
	...
	物价<input type="radio" name="xzfyReceive.refer2" value="25" id="refer225" onclick="checkRefer2('8refer','refer225')">
</td>
</tr>
<tr >
	...
	能源<input type="radio" name="xzfyReceive.refer2" value="26" id="refer226" onclick="checkRefer2('8refer','refer226')">
</td>
</tr>
<tr >
	...
	交通<input type="radio" name="xzfyReceive.refer2" value="27" id="refer227" onclick="checkRefer2('8refer','refer227')">
</td>
</tr>
<tr >
	...
	信息产业<input type="radio" name="xzfyReceive.refer2" value="28" id="refer228" onclick="checkRefer2('8refer','refer228')">
</td>
</tr>
<tr >
	...
	邮政<input type="radio" name="xzfyReceive.refer2" value="29" id="refer229" onclick="checkRefer2('8refer','refer229')">
</td>
</tr>
<tr >
	...
	烟草专买<input type="radio" name="xzfyReceive.refer2" value="30" id="refer230" onclick="checkRefer2('8refer','refer230')">
</td>
</tr>
</tbody>
...
<tr >
	...
	税务<input type="radio" name="xzfyReceive.refer2" value="32" id="refer232" onclick="checkRefer2('9refer','refer232')">
</td>
</tr>
<tr >
	...
	人民银行<input type="radio" name="xzfyReceive.refer2" value="33" id="refer233" onclick="checkRefer2('9refer','refer233')">
</td>
</tr>
<tr >
	...
	证监<input type="radio" name="xzfyReceive.refer2" value="34" id="refer234" onclick="checkRefer2('9refer','refer234')">
</td>
</tr>
<tr >
	...
	保监<input type="radio" name="xzfyReceive.refer2" value="35" id="refer235" onclick="checkRefer2('9refer','refer235')">
</td>
</tr>
<tr >
	...
	银监<input type="radio" name="xzfyReceive.refer2" value="36" id="refer236" onclick="checkRefer2('9refer','refer236')">
</td>
</tr>
<tr >
	...
	外汇<input type="radio" name="xzfyReceive.refer2" value="37" id="refer237" onclick="checkRefer2('9refer','refer237')">
</td>
</tr>
<tr >
	...
	财政<input type="radio" name="xzfyReceive.refer2" value="38" id="refer238" onclick="checkRefer2('9refer','refer238')">
</td>
</tr>
<tr >
	...
	统计<input type="radio" name="xzfyReceive.refer2" value="39" id="refer239" onclick="checkRefer2('9refer','refer239')">
</td>
</tr>
<tr >
	...
	审计<input type="radio" name="xzfyReceive.refer2" value="40" id="refer240" onclick="checkRefer2('9refer','refer240')">
</td>
</tr>
<tr >
	...
	海关<input type="radio" name="xzfyReceive.refer2" value="41" id="refer241" onclick="checkRefer2('9refer','refer241')">
</td>
</tr>
<tr >
	...
	商检<input type="radio" name="xzfyReceive.refer2" value="42" id="refer242" onclick="checkRefer2('9refer','refer242')">
</td>
</tr>
</tbody>
...
<tr >
	...
	药监<input type="radio" name="xzfyReceive.refer2" value="44" id="refer244" onclick="checkRefer2('10refer','refer244')">
</td>
</tr>
<tr >
	...
	卫生<input type="radio" name="xzfyReceive.refer2" value="45" id="refer245" onclick="checkRefer2('10refer','refer245')">
</td>
</tr>
<tr >
	...
	计划生育<input type="radio" name="xzfyReceive.refer2" value="46" id="refer246" onclick="checkRefer2('10refer','refer246')">
</td>
</tr>
<tr >
	...
	教育<input type="radio" name="xzfyReceive.refer2" value="47" id="refer247" onclick="checkRefer2('10refer','refer247')">
</td>
</tr>
<tr >
	...
	文化<input type="radio" name="xzfyReceive.refer2" value="48" id="refer248" onclick="checkRefer2('10refer','refer248')">
</td>
</tr>
<tr >
	...
	专利<input type="radio" name="xzfyReceive.refer2" value="49" id="refer249" onclick="checkRefer2('10refer','refer249')">
</td>
</tr>
<tr >
	...
	商标<input type="radio" name="xzfyReceive.refer2" value="50" id="refer250" onclick="checkRefer2('10refer','refer250')">
</td>
</tr>
<tr >
	...
	版权<input type="radio" name="xzfyReceive.refer2" value="51" id="refer251" onclick="checkRefer2('10refer','refer251')">
</td>
</tr>
<tr >
	...
	旅游<input type="radio" name="xzfyReceive.refer2" value="52" id="refer252" onclick="checkRefer2('10refer','refer252')">
</td>
</tr>
...
<div id="count2Div1" style="position:absolute;display:none;" class="diva">
 ...
 <tr>
	<td>申请复议事项：</td>
	<td >
	.抽象行政行为&nbsp<input name="xzfyReceive.keyword2"  type="radio" altname="申请复议事项" value='1'><br>
	.行政处分、人事处理决定&nbsp<input name="xzfyReceive.keyword2"  type="radio" altname="申请复议事项" value='2'><br>
	.行政机关对民事纠纷作出的调解、处理&nbsp<input name="xzfyReceive.keyword2"  type="radio" altname="申请复议事项" value='3'><br>
	.国防、外交等国家行为&nbsp<input name="xzfyReceive.keyword2"  type="radio" altname="申请复议事项" value='4'><br>
	.交通、医疗、火灾事故责任认定&nbsp<input name="xzfyReceive.keyword2"  type="radio" altname="申请复议事项" value='5'><br>
	.司法鉴定&nbsp<input name="xzfyReceive.keyword2"  type="radio" altname="申请复议事项" value='6'><br>
	.涉及刑事行为&nbsp<input name="xzfyReceive.keyword2"  type="radio" altname="申请复议事项" value='7'><br>
	.民事行为&nbsp<input name="xzfyReceive.keyword2"  type="radio" altname="申请复议事项" value='8'><br>
	.司法行为&nbsp<input name="xzfyReceive.keyword2"  type="radio" altname="申请复议事项" value='9'><br>
	.对当事人权利不产生影响的信访行为&nbsp<input name="xzfyReceive.keyword2"  type="radio" altname="申请复议事项" value='10'><br>
	.不具有强制力的行政指导&nbsp<input name="xzfyReceive.keyword2"  type="radio" altname="申请复议事项" value='11'><br>
	.其他行政复议机关对复议申请的处理&nbsp<input name="xzfyReceive.keyword2"  type="radio" altname="申请复议事项" value='12'><br>
	.涉及市政府行政复议工作的来信&nbsp<input name="xzfyReceive.keyword2"  type="radio" altname="申请复议事项" value='13'><br>
	.其他&nbsp<input name="xzfyReceive.keyword2"  type="radio" altname="申请复议事项" value='14'><br>
	</td>
	</tr>
 <tr>
	<td >接待处理：</td>
	<td >口头告知&nbsp<input name="xzfyReceive.reception"  type="radio" altname="接待处理" value='4'><br>
	.接收复议申请材料&nbsp<input name="xzfyReceive.reception"  type="radio" altname="接待处理" value='5'><br>
	.接收行政复议监督案件&nbsp<input name="xzfyReceive.reception"  type="radio" altname="接待处理" value='6'><br>
	.接收其他来信、电子邮件&nbsp<input name="xzfyReceive.reception"  type="radio" altname="接待处理" value='7'><br>
	</td>
	</tr>
</table>
...
<div id="count3Div1" style="position:absolute;display:none;" class="diva">
 ...
 <tr>
	<td>复议审理方式：</td>
	<td>送达&nbsp<input name="xzfyReceive.keyword3"  type="radio" altname="复议审理方式" value='1'><br>
	询问案件进展情况&nbsp<input name="xzfyReceive.keyword3"  type="radio" altname="复议审理方式" value='2'><br>
	阅卷&nbsp<input name="xzfyReceive.keyword3"  type="radio" altname="复议审理方式" value='3'><br>
	谈话、调查&nbsp<input name="xzfyReceive.keyword3"  type="radio" altname="复议审理方式" value='4'><br>
	当面补交申请材料、明确有关事项&nbsp<input name="xzfyReceive.keyword3"  type="radio" altname="复议审理方式" value='5'><br>
	来信补交申请材料&nbsp<input name="xzfyReceive.keyword3"  type="radio" altname="复议审理方式" value='6'><br>
	当面代为接转其他材料&nbsp<input name="xzfyReceive.keyword3"  type="radio" altname="复议审理方式" value='7'><br>
	来信、邮件提交其他材料&nbsp<input name="xzfyReceive.keyword3"  type="radio" altname="复议审理方式" value='8'><br>
	其他涉及案件审理的事项&nbsp<input name="xzfyReceive.keyword3"  type="radio" altname="复议审理方式" value='9'><br>
	</td>
	</tr>
</table>
...
function aaa(ss)
{
	...
	document.getElementById("beappname").name="xzfyReceive.defendant_name";
	...
	document.getElementById("beappnameinput").name="xzfyReceive.defendant_name";
...
function fysxCheck(){
    var refer=0;
	var disList2 = document.getElementsByName("xzfyReceive.casetype");
...
function xzlbCheck(){
    var refer=0;
	var disList2 = document.getElementsByName("xzfyReceive.refer");
	for(var i=0;i<disList2.length;i++){
		if(disList2.item(i).checked==true){
			refer=disList2.item(i).value;
...
function saveNew(id){ 
    ...
    if(checknull()&&checkKeyWord()){
		...
		var ajsjfm1s=document.getElementsByName("xzfyReceive.reception");
		var asl=0;
	...
	-->
	listForm_= document.getElementById("form1");
	listForm_.action="liAn.action?funcCode=${funcCode}&&xzfyId="+id;
	if(confirm("您确认保存吗?"))
	listForm_.submit();
}
...
function dispose()
{
	var disList = document.getElementsByName("xzfyReceive.reception");
