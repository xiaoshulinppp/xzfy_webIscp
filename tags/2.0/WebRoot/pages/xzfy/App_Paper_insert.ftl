...
<input name="xzfyInfo.count_year" type="hidden" class="inputTextNormal" ischeck="y" value=${countYear}>
 ...
 --> 
  ...
  <tr class="trwhite">
    <th >来文编号：</th>
    <td ><input name="xzfyInfo.zhize" type="text" id="zhize" class="inputTextNormal" altname="来文编号" ></td>
    <th >来信人电话：</th>
...
<td align="right"><a href="javascript:resetFile()">不添加</a></td>
</tr>
	...
	<table >
		...
		<tr><td>
		文件名：<input name="filemodel" isUser="true" />
		</td>
	<td>
	...
	<td>
	页数：<input name="filepage" isUser="true" value='（页）'/>
	</td>
	<td>
	份数：<input name="filecount" isUser="true" value='（份）'/>
