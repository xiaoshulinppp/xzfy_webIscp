...
function submitCond() {
   searchEditor.submitCond(); 

}
function clearInputValue() {
   searchEditor.clearInputValue();  
}
function addField() {
...
function addEquation() {
   ...
   searchEditor.addEquation();  
}
function addLeftBracket() {
   searchEditor.addLeftBracket();  
}
function addRightBracket() {
   searchEditor.addRightBracket();  
}
function addInputValue() {
   searchEditor.addInputValue();  
}
function addLink() {
   searchEditor.addLink();  
}
...
function SearchEditor(){
	...
	var field_element;
    var table_element;
    var inputValue_element;
    var leftBracket_element;
    var rightBracket_element;
    var dept_element;
	...
	this.init = function(field_dict_,field_type_){
		...
		this.inputValue_element=document.getElementById("inputValue");
		...
		this.leftBracket_element = document.getElementById("leftBracket_element");
        this.rightBracket_element = document.getElementById("rightBracket_element");
        this.dept_element = document.getElementById("deptHide");
	}
	...
	this.getExpShow = function(exp_item){
		...
		var exp = exp_item.link_show+" "+leftBracket+" "+exp_item.value_show+" "+rightBracket;
		return exp;
	}
	...
	this.addField = function() {	
	  ...
	  var value_for_value = this.value_input_hide.value; 
	  var field_element_value = this.getSelected(this.field_element).value;
	  var table_element_value = this.getSelected(this.table_element).value;
	  value_for_value=value_for_value+field_element_value;
	  this.value_input_hide.value = value_for_value;  

	}
	this.addEquation = function() {	
	  var value_for_show = this.value_input.value; 
	  var equation_element_show_value = this.getSelected(this.equation_element).innerHTML;
	  value_for_show=value_for_show+" "+equation_element_show_value;
	  this.value_input.value = value_for_show;
		  
	  var value_for_value = this.value_input_hide.value; 
	  var equation_element_value = this.getSelected(this.equation_element).value;
	  value_for_value=value_for_value+" "+equation_element_value;
	  this.value_input_hide.value = value_for_value; 
	
	}
	this.addLeftBracket = function() {
      var value_for_show = this.value_input.value; 
	  var leftBracket_element_show_value = this.getSelected(this.leftBracket_element).innerHTML;
	  value_for_show=value_for_show+" "+leftBracket_element_show_value;
	  this.value_input.value = value_for_show;
		  
	  var value_for_value = this.value_input_hide.value; 
	  var leftBracket_element_value = this.getSelected(this.leftBracket_element).value;
	  value_for_value=value_for_value+" "+leftBracket_element_value;
	  this.value_input_hide.value = value_for_value;   
    }
    this.addRightBracket = function(){
      var value_for_show = this.value_input.value; 
	  var rightBracket_element_show_value = this.getSelected(this.rightBracket_element).innerHTML;
	  value_for_show=value_for_show+" "+rightBracket_element_show_value;
	  this.value_input.value = value_for_show;
		  
	  var value_for_value = this.value_input_hide.value; 
	  var rightBracket_element_value = this.getSelected(this.rightBracket_element).value;
	  value_for_value=value_for_value+" "+rightBracket_element_value;
	  this.value_input_hide.value = value_for_value; 
     }
	this.addInputValue = function() {	
	  var value_for_show = this.value_input.value; 
	  var input_element_show_value = this.inputValue_element.value;
	  value_for_show=value_for_show+" '"+input_element_show_value+"'";
	  this.value_input.value = value_for_show;
	
	  
	  var value_for_value = this.value_input_hide.value; 
	  var input_element_show_value = this.inputValue_element.value;
	  value_for_value=value_for_value+" '"+input_element_show_value+"'";
	  this.value_input_hide.value = value_for_value;  
	
	}
	this.addLink = function() {	
	  var value_for_show = this.value_input.value; 
	  var link_element_show_value = this.getSelected(this.link_element).value;
	  value_for_show=value_for_show+" "+link_element_show_value;
	  this.value_input.value = value_for_show;

	  
	  var value_for_value = this.value_input_hide.value; 
	  var link_element_show_value = this.getSelected(this.link_element).value;
	  value_for_value=value_for_value+" "+link_element_show_value;
	  this.value_input_hide.value = value_for_value;  
	...
	function ExpItem(){
		...
		this.toExp = function(){
			...
			var exp = " " + this.link + " " + leftBracket + " " + valueExp  + rightBracket;
