...
<td width="5%">
主表:<@ww.select name="'queryMainTableName'" list="getAllTable()" value="getMainCustomQueryTableName()" theme ="simple" onchange="'javascript:flush()'"/><font color=red>**</font>&nbsp;
主表字段:<@ww.select name="'mainField'"  id="field_mainelement" list="getAllMainObjectField()"  onchange="'javascript:fieldChanged(this)'" theme ="simple"/><font color=red>**</font>&nbsp;
从表:<@ww.select name="'querySubTableName'" list="getAllTable()" value="getSubCustomQueryTableName()" theme ="simple" onchange="'javascript:flush()'"/><font color=red>**</font>&nbsp;
从表字段:<@ww.select name="'subField'"  id="field_mainelement" list="getAllSubObjectField()"  onchange="'javascript:fieldChanged(this)'" theme ="simple"/><font color=red>**</font>&nbsp;
</td>
<td width="5%">
