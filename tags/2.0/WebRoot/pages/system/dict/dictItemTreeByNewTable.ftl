...
<script language="JavaScript" src="../js/tree/treeNewTable.js" object="" style="display:" width = "16",height="16"></script>
<script>
...
function setValue(){
	node = this.object;
	parent.mainframe.location="./updateDictItemByNewTable.action?dictId=${entityId}&funcCode=${funcCode}&opName=${opName}&dictType=${type}&dictItemId="+node.id;
}
serverUrl = "./showDictItemServerByNewTable.action?funcCode=${funcCode}";
...
root.nameElement.onclick = function(){
  parent.mainframe.location="./createDictItemByNewTable.action?funcCode=${funcCode}&dictId=${entityId}&parentId=0&opName=create";
}
