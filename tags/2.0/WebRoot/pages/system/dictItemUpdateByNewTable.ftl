...
<body>
<@ww.form  name="'dictItemForm'" action ="'doUpdateDictItemByNewTable'" validate="'true'" disableSubmit="'saveid'" method="'post'">
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabtitle">
 ...
 <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
        <tr>
          ...
          <#if dictType=="1">
          <td width="100" class="cardNormal"><a href="../system/listDictItemByNewTable.action?dictId=${dictId}&parentId=${dictItemId}&pageNum=${pageNum}&funcCode=${funcCode}" class="cardLink">${action.getText("dictitem.dictitemsubinfo")}</a></td>
          </#if>
		  <td class="cardTh">&nbsp;</td>
        </tr>
  </table>
      <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0" class="tabMainCard">
        <tbody>
          <tr>
            ...
            <#include 'dictItemNewTableProperty.ftl'>
          </td>
          </tr>
  </tbody> </table>
...
<script>
    function delItem() {
    submitDisableButton();
    window.location='../system/deleteDictItemMain.action?funcCode=${funcCode}&dictId=${dictId}&parentId=${dictItemId}&dictItemId=${dictItemId}&selectRecord=${dictItemId}&opName=delete';
    }
...
<#if dictItem?has_content>
<input type ='hidden' name ='dictItemId' value='${dictItem.id}'>
</#if>
</@ww.form>
