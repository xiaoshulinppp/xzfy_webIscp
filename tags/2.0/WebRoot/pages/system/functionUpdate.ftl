...
<body>
<@ww.form  name="'funcForm'" action ="'doUpdateFunction'" validate="'true'" disableSubmit="'saveid'" method="'post'">
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabtitle">
 ...
 <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
        <tr>
          ...
          <td width="100" class="cardNormal"><a href="../system/listFunction.action?parentId=${entityId}&pageNum=${pageNum}&funcCode=${funcCode}" class="cardLink">${action.getText("func.funcsubinfo")}</a></td>
		  <td class="cardTh">&nbsp;</td>
        </tr>
  </table>
<#include 'functionProperty.ftl'>    
      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabMainBot">
        <tr>
          ...
          <input name="Button262" type="button" class="button" value="${action.getText("func.delitem")}" onClick="delItem()"></td>
        </tr>
      </table>
      <br>
<script>
    function delItem() {
    submitDisableButton();
    window.location='../system/deleteFunction.action?funcCode=${funcCode}&parentId=${entityId}&entityId=${entityId}&selectRecord=${entityId}&opName=delete';
    }
