...
<body>
<@ww.form  name="'serviceForm'" action ="'doCreatetService'" validate="'true'" disableSubmit="'saveid,returnid'" method="'post'">
...
<script>
    function returnPage() {
    submitDisableButton();
     document.location.href="../system/listService.action?funcCode=${funcCode}&pageNum=${pageNum}";
    }
