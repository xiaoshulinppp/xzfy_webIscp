...
<#elseif type==2><#-- 应用日志 -->
	<tr>
		<td class="tdFormText">操作者</td>
		<td class="tdFormInput"><input type="text" class="inputTextNormal required" name="appLog.creator" value="${appLog.creator?default("")}" readonly></td>
	</tr>
	<tr>
		<td class="tdFormText">操作名</td>
		<td class="tdFormInput"><input type="text" class="inputTextNormal required" name="appLog.op" value="${appLog.op?default("")}" readonly></td>
	</tr>	
	<tr>
		<td class="tdFormText">操作模块</td>
		<td class="tdFormInput"><input type="text" class="inputTextNormal required" name="appLog.module" value="${appLog.module?default("")}" readonly></td>
	</tr>
	<tr>
		<td class="tdFormText">操作内容</td>
		<td class="tdFormInput"><input type="text" class="inputTextNormal required" name="appLog.content" value="${appLog.content?default("")}" readonly></td>
	</tr>	
	<tr>
		<td class="tdFormText">操作时间</td>
		<td class="tdFormInput"><input type="text" class="inputTextNormal required" name="appLog.createTime" value="${appLog.createTime?default("")}" readonly></td>
	</tr>
</#if>
