        ...
        <tr class="trColor">
          <td class="tdFormCenter">
              ...
              <#list fieldList as field>
                 <option value="${field.name}">${field.showName}</option>
              </#list>
              </select>
          </td>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabMainBot">
  <tr>
    <td><input  type="button" class="button" value="确定" onClick="submitField()"/>
...
function submitField(){
	...
	window.opener.setShowFieldValue(selectShowField);
	window.close();
}
</script>
