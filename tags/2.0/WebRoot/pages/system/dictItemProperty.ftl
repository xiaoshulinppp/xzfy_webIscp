...
<#if opName == "view">
  ...
  <tr class="trcolor">
      ...
      <td class="tdFormInput"><@ww.select  name="'dictItem.state'"     list="getDictMap('state')"  cssClass ="'selectStyleNormal'" disabled ="'${showState}'"  theme="'simple'"/><font color=red>**</font></td>
  </tr>
