...
<div class="ui-title fn-clear">
     <span class="ui-title-icon fn-left"><img src="../sys_theme/images/icons/crumb.png"/></span>
      <h2 class="ui-title-cnt fn-left">案件列表</h2>  
...
<div class="ui-search fn-clear" >
		    ...
		    <table id=""class="ui-table ui-table-search  "  summary="这是一个1行4列的表格样式模板">
		        ...
		        <tr>
		          <td >立案日期</td>
		          <td><input class="ui-input-wdm" type="text" onClick="WdatePicker()" name="liAnDate" value="${liAnDate?default('')}"/></td>
		         <td >申请人</td>
		          <td ><input class="ui-input-wdm" type="text"  name="appName" value="${appName?default('')}" /></td>
		          <tr>
		         <td>被申请人</td>
		         <td ><input class="ui-input-wdm" type="text"  name="defendant" value="${defendant?default('')}" /></td>
		          <td >案号</td>
		          <td ><input class="ui-input-wdm" type="text" name="tjzfzh" value="${tjzfzh?default('')}"  /></td>
		          
		         </tr>
		         <tr>
		         <td >承办人</td>
		          <td  ><input class="ui-input-wdm" type="text"  name="admit" value="${admit?default('')}" /></td>
		          <td></td>
		          <td></td>
		         </tr>
		          </tbody>
...
<td>&nbsp;<#if info.admit1?has_content>${info.admit1}、</#if><#if info.admit2?has_content>${info.admit2}</#if></td>
<td>&nbsp;未办理</td>
<td><a href="../bsqr/showXzfyInfo.action?funcCode=${funcCode}&xzfyId=${info.id}&userLocbm=${userLocbm}"><img src="../images/15B/sicons/file_modf.gif"  width="16" height="16" border="0"></a></td>
</tr>
</#list>
</tbody>
</table>
