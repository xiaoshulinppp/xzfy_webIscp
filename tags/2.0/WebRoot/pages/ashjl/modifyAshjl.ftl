...
<form id="form" name="form" method="post" ENCTYPE="multipart/form-data">
	<div class="ui-title fn-clear">
		<span class="ui-title-icon fn-left"><img src="../sys_theme/images/icons/crumb.png"/></span>
      	<h2 class="ui-title-cnt fn-left">修改案审会记录</h2>
      	</span>
	</div> 
	<div class="z_info"> 
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="z_info_table">
			...
			<tr>
				...
				<td>
				    <select name="comtStr" id="host" onchange="selecthost()">
				    	...
				    	<option value="${comt.comtName},${comt.comtId}" <#if host.committeeName==comt.comtName>selected</#if>>${comt.comtName}</option>
				    	</#list>	
				    </select>
			...
			<tr>
				...
				<td class="tdFormInput">
				    ...
				    <#if wypj.committeeName==comt.comtName><input type="checkbox" name="checkbox" id="checkbox${comt_index}" value ="${comt.comtName};${comt.comtId}" checked disabled>${comt.comtName}<br>
				    </#if>
					</#list>
					</#list>
