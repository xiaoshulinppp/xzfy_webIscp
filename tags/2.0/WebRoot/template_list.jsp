...
public String GetTemplateList()
    {
        ...
        try{
        	...
        	while (rs.next())
            {
	            ...
	            s_List += "<td>";
	            s_List += "<a href='bac_template_content_save.jsp?d_templateid=" + rs.getString("D_TemplateID") + "&d_filetype=" + rs.getString("D_FileType") + "&action="+workModel+"'>整合编辑</a>&nbsp;";
	            s_List += "<a href='template_edit.jsp?d_templateid=" + rs.getString("D_TemplateID") + "&d_filetype=" + rs.getString("D_FileType") + "&action=edit'>编辑</a>&nbsp;";
	            s_List += "<a href='template_delete.jsp?d_templateid=" + rs.getString("D_TemplateID") + "'>删除</a>";
	            s_List += "</td>";
	            s_List += "</tr>";
...
<div id="nav">您当前位置 &gt;&gt; <a href="default.jsp">eWebOffice示例首页</a> &gt;&gt; 模板管理</div> 
<hr />

<table border=0 width="100%">
<tr>
    <td>
        <input type=button class="btn" value="新建Word模板整合"  onclick="location.href='bac_template_save.jsp?d_filetype=doc&action=new';">
        <input type=button class="btn" value="新建Word模板"  onclick="location.href='template_edit.jsp?d_filetype=doc&action=new';">
    </td>
    <td align="center">
