package com.taiji.waiwangTB.domain;

import java.io.Serializable;
import java.util.LinkedHashSet;
import java.util.Set;

public class XzfyInfo2 implements Serializable{
	...
	private java.lang.String agent_phone;
	...
	private java.lang.String check_file_cang;
...
//					市国土局（3000）、市规划委（3100）、市政府办公厅信息公开一处（0000
	...
	private String  zl_time;//转录时间，通过是否为空查询是否转录，转录点保存是单独赋值。
	
	
	
	public java.lang.String getCheck_file_cang() {
		return check_file_cang;
	}

	public void setCheck_file_cang(java.lang.String check_file_cang) {
		this.check_file_cang = check_file_cang;
	}
...
*/
	...
	public java.lang.String getAgent_phone() {
		return agent_phone;
	}

	public void setAgent_phone(java.lang.String agent_phone) {
