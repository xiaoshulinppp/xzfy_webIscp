		...
		<div id="bdy">
			...
			<hr />
						<%if(ms_NodeDesc.equals("阅读")){ %>
							...
							<% }else{%>
			<form id="form1" name="form1" method="post" action="bac_document_shenpidanweishenpi_save.jsp?caseId=<%=ms_caseId%>&d_username=<%=ms_Author%>&d_checkstatus=<%=ms_checkstatus%>"
