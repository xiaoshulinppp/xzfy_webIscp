<#macro multiTable  formName displayInfo funcCode pageNum  nameSpace actionName params  mainIdName subUrl subParams> 
...
<table width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="tabout" >
   ...
   <tr class="trcolor">
    ...
    <#if seq != 1>
     <td class="tdlistCenter"><a href ="${subUrl}?funcCode=${funcCode}&${mainIdName}=${keyColumn}&returnPageNum=${pageNum}${subParams}">     
    ...
    <#list displayInfo.operationList as op>
          <#if op.single !=0>
       <td class="tdlistCenter"><a href="../${nameSpace}/${op.abbr}${actionName}?opName=${op.abbr}&entityId=${keyColumn}&funcCode=${funcCode}&pageNum=${pageNum}${params}"><img src="../${Session["_USER_STYLE_"].imagePath}/sicons/${op.image}" alt="${op.name}" width="16" height="16" border="0"></a></td>
       </#if>
    </#list>
  </tr>
  </#list>
