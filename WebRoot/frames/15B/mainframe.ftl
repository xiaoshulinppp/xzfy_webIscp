...
<title>信息采集报送平台V2.0</title>
</head>
<link rel="stylesheet" href="../../${Session["_USER_STYLE_"].cssPath}/main_style.css" type="text/css">

    <FRAMESET id="mainframeset" border="0" frameSpacing="0" cols="200,8,*" onLoad="controlFrame.hidemenu();"> 
      <FRAME border="0" name="leftFrame" src="../../system/getMenuAction.action" frameBorder="0" scrolling="NO">
