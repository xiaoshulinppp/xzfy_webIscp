...
function checksqr(){
	if(document.getElementById("applicationtype").value==2){
		...
		document.getElementById("appname1").value="";
		document.getElementById("deputy").value="";
		renCount();
	}
}
...
function checkFr(){
	...
	document.getElementById("appname1").value=userString;
	renCount();
//	setAppname();
...
function checkFr_w(){  //faren
	...
	document.getElementById("rencount").value=frsqr.length;
	document.getElementById("appname1").value=userString+"  共"+frsqr.length+" 人";
	document.getElementById("agentDetail_cang").value=userString_cang;
	renCount();
//	setAppname();
//	setCountAppname('shenqingren','rencount');
}
