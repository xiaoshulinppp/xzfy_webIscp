...
function resetFrame(){
	...
	document.getElementById('subframe').style.width=40+"px";  
	}
	else{
	var k=w-240;
	document.getElementById('mainframe').style.width=k+"px";	
	document.getElementById('subframe').style.width=240+"px"; 
...
function resizeFramedbClick(divid){
   ...
   document.getElementById('mainframe').style.width=t+"px"; 
     document.getElementById('subframe').style.width=40+"px"; 
	alert(document.getElementById('mainframe').style.width); 
	}
	else{
	var k=w-240;
	document.getElementById('mainframe').style.width=k+"px";	
