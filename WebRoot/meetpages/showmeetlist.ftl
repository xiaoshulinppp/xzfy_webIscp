			...
			<#list bananList as xzfyInfo>
				<tr >
					...
					<td  >&nbsp;
						...
						<td >
						<a href="../meet/updateyuejuan.action?tempid=${xzfyInfo.id}&funcCode=${funcCode}">提取</a>&nbsp;
						</td>
	...
	<div class="pageNum">
			<tr align="center">
				<td>第${pageNum}/${totalPage}页 
					...
					<a onclick="gopage('${downPage}')"  href ="javascript:;">下一页</a>
...
电话：65193431
	...
	<script type="text/javascript">
			...
			function gopage(mpage){
				window.location = "../meet/showDaibanList.action?funcCode=${funcCode}&pageNum=" + mpage  + "&status=0";
			}
			...
			function gotoPage(){
				...
				if(inputPage > ${totalPage}){
					...
					window.location = "../meet/showDaibanList.action?funcCode=${funcCode}&pageNum=" + inputPage + "&status=0";
				}
				return;
			}
