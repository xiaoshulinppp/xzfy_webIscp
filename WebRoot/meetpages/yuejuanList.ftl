...
<td><a href="../meet/viewYibanjiedai.action?funcCode=${funcCode}&Main_id=${meet.main_id}" ><font color="green">查看</font></a></td>
            ...
            <div class="pageNum">
               第${pNum}/${totalPage}页   共${totalCount}条
				...
				<a href="../meet/showYueJuanList.action?pNum=1&funcCode=${funcCode}" class="ui-page-item ui-page-item-first">首页</a>
			    <a href="../meet/showYueJuanList.action?pNum=${upPage}&funcCode=${funcCode}" class="ui-page-item ui-page-item-prev">上一页</a>
		     	<a href="../meet/showYueJuanList.action?pNum=${downPage}&funcCode=${funcCode}" class="ui-page-item ui-page-next">下一页</a>
			    <a href="../meet/showYueJuanList.action?pNum=${totalPage}&funcCode=${funcCode}" class="ui-page-item ui-page-last">尾页</a>　
...
window.location = "../meet/showYueJuanList.action?funcCode=${funcCode}&pNum=" + inputPage + "";
