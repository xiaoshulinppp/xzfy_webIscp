			...
			<#list bananList as xzfyInfo>
				<tr >
					...
					<td  >
						...
						<td >
						<a href="../meet/updatezhuanjiaocailiao.action?tempid=${xzfyInfo.id}&funcCode=${funcCode}">提取</a>&nbsp;
						</td>
...
电话：65193431
	...
	<script type="text/javascript">
			...
			function gopage(mpage){
				window.location = "../meet/showDaibanList2.action?funcCode=${funcCode}&pageNum=" + mpage  + "&status=0";
			}
			...
			function gotoPage(){
				...
				if(inputPage > ${totalPage}){
					...
					window.location = "../meet/showDaibanList2.action?funcCode=${funcCode}&pageNum=" + inputPage + "&status=0";
				}
				return;
			}
