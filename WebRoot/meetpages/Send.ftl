...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <tr class="trcolor">
	 ...
	 <td class="tdFormInput" colspan=3>
	  <textarea name="meet.Send_content" style="overflow-y:visible;" rows="10" id="answerValue" type="text" class='textarea' ondblclick="getValue(this)">
接待人询问：今天在此向被接待人送达法律文书《行政复议      》（京政复字[200 ]   号）。
	...
	function createApp(){
		if(confirm("确认提交？")){
			...
			window.createForm.submit();
				window.open("http://localhost:8080/webIscp/bac_document_edit.jsp?action=new&d_filetype=doc&d_templateid=20131012070846&d_username=panglei&caseId=1");
		}
