...
<div class="wal pageNow2">
      <div class="fl">当前位置：&nbsp;&nbsp;<a href="../xzfy/gotoIndex.action?funcCode=${funcCode}">首页  </a> >&nbsp;&nbsp;  <a href="../xzfy/openReceive.action?funcCode=${funcCode}">接收/新增案件</a>  >&nbsp;&nbsp; 行政复议申请材料处理——送达</div>

</div>
<div class="wal">

      <div class="formTitle2">行政复议申请材料处理——送达</div>
      <div class="form3">
...
<script type="text/javascript">
	function saveApp(){
		...
		if(confirm("确认提交？")){
			...
			window.createForm.action="saveFace2.action";
	...
	function callbackfun2(){
		var url ="../fzb_default_dafutongzhi.jsp?&d_filetype=doc&d_username=${Session['_USER_LOGIN_'].id}&caseId=${mainidd}&mstype=songdabilu";
