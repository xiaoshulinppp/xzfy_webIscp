...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form id="updateForm" action="../webTemplate/updateTemplate.action" method="post"  enctype="multipart/form-data">
		<table width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="tabout">
			...
			<tr class="trwhite">
				...
				<td class="tdFormInput">
					<input type="text" id="templateName" value="${wtTemplate.name}" class="inputTextNormal" />
				</td>
				<td class="tdFormText">功能链接</td>
				<td class="tdFormInput">
					<input type="text" id="templateFunction" value="${wtTemplate.function}" class="inputTextNormal" />
				</td>
			</tr>
			<tr class="trwhite">
				...
				<td class="tdFormInput">
					<input type="text" id="templateSeq" value="${wtTemplate.seq}" class="inputTextNormal" />
				</td>
			</tr>
			<tr class="trwhite">
				<td class="tdFormText">模板简介</td>
				<td class="tdFormInput" colspan="3">
					<textarea id="templateIntroduction" cols="40" rows="5" class="textarea">${wtTemplate.introduction}</textarea>
				</td>
			</tr>
		</table>
		<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabMainBot">
			<tr>
				<td>
					<input type="button" class="button" value="提 交" onclick="updateTemplate();" />
					<input type="button" class="button" value="返 回" onclick="gotoBack();" />
				</td>
			</tr>
			<input type="hidden" name="funcCode" value="${funcCode}" />
			<input type="hidden" id="entityId" name="entityId" value="${wtTemplate.id}" />
