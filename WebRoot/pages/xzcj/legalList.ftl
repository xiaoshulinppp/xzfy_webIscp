	...
	<body>
		...
		<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabout">
			<tr>
				...
				<th class="thListNormal" width="10%">其他情形</th>
			...
			<tr class="trColor">
				...
				<td class="tdlistCenter">
				<#if data.deputyType?has_content>${data.deputyType}</#if></td>
				
				<td class="tdlistCenter">
				<#if data.mail_address?has_content>${data.mail_address}</#if></td>
				...
				<td class="tdlistCenter">
				<#if data.otherType?has_content>${data.otherType}</#if></td>
