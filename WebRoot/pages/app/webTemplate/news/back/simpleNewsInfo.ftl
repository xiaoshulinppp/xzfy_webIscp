	...
	<body>
		...
		<table width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="tabout">
			...
			<tr class="trwhite">
				...
				<td class="tdFormInput" colspan="3">${newsTemplate.title}</td>
			</tr>
			<tr class="trwhite">
				<td class="tdFormText">新闻编辑</td>
				<td class="tdFormInput" colspan="3">${newsTemplate.editor}</td>
			</tr>
			<tr class="trwhite">
				<td class="tdFormText">新闻来源</td>
				<td class="tdFormInput" colspan="3">${newsTemplate.source}</td>
			</tr>
			<tr class="trwhite">
