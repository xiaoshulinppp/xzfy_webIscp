...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form id="createForm" action="../appNewsTemplate/createSimpleNews.action" method="post" enctype="multipart/form-data">
		<table width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="tabout">
			...
			<tr class="trwhite">
				...
				<td class="tdFormInput">
					<input type="text" name="newsTemplate.title" value="" class="inputTextNormal" />
				</td>
				<td class="tdFormText">新闻编辑</td>
				<td class="tdFormInput">
					<input type="text" name="newsTemplate.editor" value="" class="inputTextNormal" />
				</td>
			</tr>
			<tr class="trwhite">
				...
				<td class="tdFormInput">
					<input type="text" name="newsTemplate.source" value="" class="inputTextNormal" />
				</td>
			</tr>
			<tr class="trwhite">
