...
<div class="wal pageNow2">
      <div class="fl">当前位置：<a href="../xzfy/gotoIndex.action?funcCode=${funcCode}">首页 </a>->统计查询->其他->处室工作管理</div>
      <div class="fr"></div>
</div>
...
<div class="wal">
		...
		<li style="width:180px">  
		    <div class="name">开始日期:</div>
		     <input class="ui-input-wdm" onclick="WdatePicker()" readonly="readonly" name="us2" id="us2" value="${us2}" type="text">
		
		    <input class="ui-input-wdm" onclick="WdatePicker()" readonly="readonly" name="startDate2" id="startDate2" value="${startDate2}" type="text">
		</li>
		<li style="width:170px">  
		    <div class="name">结束日期:</div>
		    <input class="ui-input-wdm" onclick="WdatePicker()" readonly="readonly" name="endDate2" id="endDate2" value="${endDate2}" type="text">
		</li>
	</ul>
               </div>
...
<script>
         function gotoSearch(v){
         	...
         	document.checkForm.action="div52Result_2.action";
