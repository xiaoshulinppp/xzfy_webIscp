...
<div class="wal pageNow2">
      <div class="fl">当前位置：<a href="../xzfy/gotoIndex.action?funcCode=${funcCode}">首页 </a>->统计查询->行政复议机关案件统计->高级检索（全部案件）</div>
      <div class="fr"></div>
</div>
            ...
            <div class="searchList">
               <table width="100%" border="0" cellpadding="0" cellspacing="0">
                   <tr>
					  ...
					  <th width="12%">案件编号</th>
					  <th width="10%">复议机关</th>
					  <th width="12%">申请人名称</th>
					  <th width="10%">具体行政行为</th>
...
<script>
         function gotoSearch(v){
         	...
         	document.checkForm.action="showQueryResult.action";
