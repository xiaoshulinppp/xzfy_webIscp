...
<body>
<@ww.form  name="'mappingTableForm'"  action ="'doUpdateMappingTable'" validate="'true'" disableSubmit="'saveid,returnid'" method="'post'">
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="yourPlace">
    <tr>
         <td>${action.getText("current.location")}:${action.getText("mappingtable.title")}</td>
      </tr>
...
<#include "mappingTableProperty.ftl">
...
<script>
    function returnPage() {
    submitDisableButton();
     document.location.href="../system/listMappingTable.action?funcCode=${funcCode}&pageNum=${pageNum}";
    }
...
<input type ='hidden' name ='entityId' value='${table.id}'>
</@ww.form>
</body>
</html>