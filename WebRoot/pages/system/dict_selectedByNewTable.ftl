...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabMainBot">
  <tr>
    <td>
<input name="Button22" type="button" class="button" value="确 定" onClick="javascirpt:window.close()">
    </td>
  </tr>
</table>
<script>
...
serverUrl = "./showDictItemServerByNewTable.action?funcCode=${funcCode}&fliterCond=${fliterCond}";
