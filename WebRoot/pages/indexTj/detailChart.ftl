...
<div class="wal">
                   ...
                   <div class="pageBox" style="padding:10px;">
                         ...
                         <div class="Statistics">
                              ...
                              <script type="text/javascript">
				              var chartx= new FusionCharts("../pages/fusionCharts/chartsflash/Column2D.swf", "Divx1", "900", "400", "0", "0");
				              chartx.setDataXML("${xmlString}");	
				              chartx.render("Divx1");
				              
			                  </script>
                               
                               
                             <div class="title">${jktype?default('')}</div>
