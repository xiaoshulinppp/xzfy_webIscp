...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>	
		...
		<form id="form1" name="form1" action="''" method="post" ENCTYPE="multipart/form-data">
			...
			<input type="hidden" name="xzfyDftz.sentanswerdate" value="" />
			...
			<table width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="tabout">
				<tr class="trcolor" align="center"> 
					<input type="button" value="办案信息" class="ui-btn ui-btn-normal" onclick="banan()" />
		...
		<div class="ui-form fn-clear">
			<table id="dftz" style="display:none" width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="ui-table ui-table-form">	  			
		  		...
		  		<tr class="trcolor"   >  			   
					<th class="tdFormText" width="20%" >请添加材料</td>
					<td class="tdFormText" width="80%" colspan="3">
						<input type="file" name="upFile2" class="inputTextFile" />
						<input type="file" name="upFile3" class="inputTextFile" />
		  		...
		  		<tr class="trcolor"  >  			   
					<td class="tdFormText" width="25%" colspan="4">
						<div align="center">
							<input type="button" value="生成文书" class="ui-btn ui-btn-normal" onclick="saveToDftzDoc()" >
							<input type="button" value="发送通知" class="ui-btn ui-btn-normal" onclick="commitDftz()" >
		...
		<div class="ui-form fn-clear">
			<table id="yanqi" <#if xzfyInfo.status=="5">style="display:block"</#if> style="display:none" width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="ui-table ui-table-form">	  			
		  		...
		  		<tr class="trcolor"  >  			   
					<td class="tdFormText" width="25%" colspan="4">
						<div align="center">							
							<input type="button" class="ui-btn ui-btn-normal"  <#if xzfyInfo.status?exists && xzfyInfo.status != "4" && xzfyInfo.status != "5" && xzfyInfo.status != "10" || xzfyInfo.check_status != "0" || isde != "0" >disabled</#if> value="提交审批" onclick="tijiaoshenpi5()" />
							<input type="button" class="ui-btn ui-btn-normal"   value="取消审批" onclick="withdrawsp()" />
							<input type="button" class="ui-btn ui-btn-normal"  <#if xzfyInfo.status?exists && xzfyInfo.status != "4" && xzfyInfo.status != "5" && xzfyInfo.status != "10" || xzfyInfo.check_status != "0" || isde != "0" >disabled</#if> value="完成延期" onclick="save6()" />
							<br/>审批请点提交审批按钮，通过后再点击完成延期。不审批请直接点击完成延期					
						</div>						
					</td>      		
		  		</tr>				
			</table>
		...
		<div class="ui-form fn-clear">
			<table id="zhongzhi" <#if xzfyInfo.status=="7">style="display:block"</#if> style="display:none" width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="ui-table ui-table-form">	  			
		  		...
		  		<tr class="trcolor"  >  			   
					<td class="tdFormText" width="25%" colspan="4">
						<div align="center">							
							<input type="button" class="ui-btn ui-btn-normal" <#if xzfyInfo.status?exists && xzfyInfo.status != "4" && xzfyInfo.status != "6" && xzfyInfo.status != "7" && xzfyInfo.status != "10" || xzfyInfo.check_status != "0" || isst != "0"  >disabled</#if>  value="提交审批" onclick="tijiaoshenpi7()" />
							<input type="button" class="ui-btn ui-btn-normal"   value="取消审批" onclick="withdrawsp()" />
							<input type="button" class="ui-btn ui-btn-normal" <#if xzfyInfo.status?exists && xzfyInfo.status != "4" && xzfyInfo.status != "6" && xzfyInfo.status != "7" && xzfyInfo.status != "10" || xzfyInfo.check_status != "0" || isst != "0" >disabled</#if>  value="完成中止" onclick="save8()" />	
							<br/>审批请点提交审批按钮，通过后再点击完成中止。不审批请直接点击完成中止。						
						</div>
					</td>      		
		  		</tr>				
			</table>
		...
		<div class="ui-form fn-clear">
			<table id="huifushenli" <#if xzfyInfo.status=="9">style="display:block"</#if> style="display:none" width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="ui-table ui-table-form">	  			
		  		...
		  		<tr class="trcolor"  >  			   
					<td class="tdFormText" width="25%" colspan="4">
						<div align="center">						
							<input type="button" class="ui-btn ui-btn-normal" <#if xzfyInfo.status?exists && xzfyInfo.status != "9" && xzfyInfo.status != "8" || xzfyInfo.check_status != "0" >disabled</#if> value="提交审批" onclick="tijiaoshenpi9()" />
							<input type="button" class="ui-btn ui-btn-normal"   value="取消审批" onclick="withdrawsp()" />
							<input type="button" class="ui-btn ui-btn-normal" <#if xzfyInfo.status?exists && xzfyInfo.status != "9" && xzfyInfo.status != "8" || xzfyInfo.check_status != "0" >disabled</#if>   value="完成恢复" onclick="save10()" />								
							<br/>审批请点提交审批按钮，通过后再点击完成恢复。不审批请直接点击完成恢复。		
						</div>
					</td>      		
		  		</tr> 				
			</table>
		...
		<div class="ui-form fn-clear">
			<table id="jiean" <#if xzfyInfo.status=="11">style="display:block"</#if> style="display:none" width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="ui-table ui-table-form">	  			
		  		...
		  		<tr class="trcolor" id="" >      
				    ...
				    <td class="tdFormInput" width="30%" >	
						...
						<#--  <option value="2" <#if xzfyInfo.finishBreakType?exists && xzfyInfo.finishBreakType=="2">selected</#if> >资源撤回申请 </option>-->
						  <option value="5" <#if xzfyInfo.finishBreakType?exists && (xzfyInfo.finishBreakType=="5" || xzfyInfo.finishBreakType=="2" || xzfyInfo.finishBreakType=="3" )>selected</#if> >被申请人改变后撤回申请</option>
		  		...
		  		<tr class="trcolor"  >  			   
					<td class="tdFormText" width="25%" colspan="4">
						<div align="center">
							<input type="button" class="ui-btn ui-btn-normal" <#if xzfyInfo.status?exists && xzfyInfo.status != "4" && xzfyInfo.status != "6" && xzfyInfo.status != "11" && xzfyInfo.status != "10" || xzfyInfo.check_status != "0" >disabled</#if> value="提交审批" onclick="tijiaoshenpi11()" />
							<input type="button" class="ui-btn ui-btn-normal"   value="取消审批" onclick="withdrawsp()" />
							<input type="button" class="ui-btn ui-btn-normal" <#if xzfyInfo.status?exists && xzfyInfo.status != "4" && xzfyInfo.status != "6" && xzfyInfo.status != "11" && xzfyInfo.status != "10" || xzfyInfo.check_status != "0" >disabled</#if> value="完成结案" onclick="save12()" />								
							<br/>审批请点提交审批按钮，通过后再点击完成结案。不审批请直接点击完成结案。							
						</div>
					</td>      		
		  		</tr>				
			</table>
...
<!--=============================================================================================================================================-->		
		...
		<div class="ui-form fn-clear">
			...
			<br/><br/>
			<table id="banan" width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="ui-table ui-table-form">	
		  		<tr class="trcolor">      
