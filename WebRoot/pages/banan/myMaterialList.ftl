...
<form name="Form1" id="Form1" action="" method="post">
	...
	<div id="searchForm">
		<div class="pageBox">
			<div class="searchForm">
				...
				<div class="btnDiv">
					<input type="button" value="新增" class="btn1" onclick="opendg('../material/createMaterial.action?funcCode=${funcCode}',800,370)" />
					<input type="button" value="返回" class="btn1" onclick="back()" />
				</div>
			</div>
		</div>
	...
	<div class="pageBox">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<#list myMaterialList as materialSharing>
			<tr>
				<td>${account}</td>
				...
				<td>&nbsp;<a href="javascript:opendg('../material/showMaterial.action?ViewOrModify=1&funcCode=${funcCode}&tempid=${materialSharing.id}',800,370)">编辑</a></td>				
			</tr>
            ...
            <div class="pageNum">
               第${pNum}/${totalPage}页   共${totalCount}条
				...
				<a href="../material/showMyMaterialList.action?pNum=1&funcCode=${funcCode}" class="ui-page-item ui-page-item-first">首页</a>
			    <a href="../material/showMyMaterialList.action?pNum=${upPage}&funcCode=${funcCode}" class="ui-page-item ui-page-item-prev">上一页</a>
		     	<a href="../material/showMyMaterialList.action?pNum=${downPage}&funcCode=${funcCode}" class="ui-page-item ui-page-next">下一页</a>
			    <a href="../material/showMyMaterialList.action?pNum=${totalPage}&funcCode=${funcCode}" class="ui-page-item ui-page-last">尾页</a>　
...
<script>
	...
	function createMaterial(){
		window.Form1.action="createMaterial.action";
		window.Form1.submit();
		...
		function back(){		
			window.Form1.action="../website/zlkk.action";
			document.Form1.submit();
		}
		...
		function gotoPage(){
				...
				if(inputPage > ${totalPage}){
					...
					window.location = "../material/showMyMaterialList.action?funcCode=${funcCode}&pNum=" + inputPage + "";
				}
				return;
			}
