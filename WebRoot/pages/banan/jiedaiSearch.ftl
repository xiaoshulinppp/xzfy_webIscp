...
<input type="hidden" name="funcCode" value="${funcCode}" />
				...
				<div id="countDiv" style="display:block">
			            ...
			            <div class="dataList">
				            <ul>
					   			<li><a href="javascript:showSearchProperty(1)" >当面接待a</a></li>
					   			<li><a href="javascript:showSearchProperty(2)" >一般接待</a></li>
					   			<li><a href="javascript:showSearchProperty(3)" >阅卷查询</a></li>
					   			<li><a href="javascript:showSearchProperty(4)" >送达查询</a></li>
					   			<li><a href="javascript:showSearchProperty(5)" >转交材料</a></li>
				   			</ul>
			   			</div>
