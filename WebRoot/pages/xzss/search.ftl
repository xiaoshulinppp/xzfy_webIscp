...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<#if panduanGL != "1" && panduanGL != "2">
		...
		<div class="wal pageNow2">
	      ...
	      <a href="../xzss/showUndertakerList.action?funcCode=${funcCode}">行政诉讼案件列表</a> >诉讼案件高级检索（本单位）</div>
	      <div class="fr"></div>
		</div>
	</#if>	
		...
		<br/>
			<div align="center" class="btnDiv" style="">
...
<script type="text/javascript">
	function search(){
		//alert(111)
		window.form1.action="dosearch.action";
		window.form1.submit();
