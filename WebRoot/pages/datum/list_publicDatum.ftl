...
<script>
	function sousuo(){
		window.listForm.action="../datum/gotoPublicList.action";
...
<div class="ui-search fn-clear" >
    ...
    <table id=""class="ui-table ui-table-search  "  summary="这是一个1行4列的表格样式模板">
        ...
        <tr>
          ...
          <td><input class="ui-input-wdm" type="text" name="zlmc"  /></td>
        ...
        <tr>
          ...
          <td ><input class="ui-input-wdm" type="text" name="gjc"  /></td>
          <td class="fn-text-right" >摘要</td>
          <td  ><input class="ui-input-wdm" type="text"  name="zy" /></td>
         </tr>
          
            <tr>
           <td class="fn-text-right" >上传人</td>
          <td ><input class="ui-input-wdm" type="text"  name="scr" /></td>
           <td colspan="2" class="fn-text-center">
           <input  class="ui-btn ui-btn-yellow" type="button" name="button" id=""  value="搜索"  title="搜索" onclick="sousuo()"/>
           <input class="ui-btn ui-btn-normal" type="reset" value="重置" title="重新填写" onclick="document.inputForm.reset();"/>
           </td>
         </tr>
          </tbody>
...
<div class="case-title case-title-bg clearfix">
					...
					<a href="../datum/gotoInsertDatum.action?funcCode=${funcCode}',800,500)" class="case-btn case-btn-blue fr">上传资料</a>
				</div>
<div class="list-survey fn-clear">
	 <table class="ui-table table-survey" >
    
      <tr>
      <td><span style="color:orange"><h4>待审信息</h4><font>65</font></span></td>
      <td><span style="color:blue"><h4>审核中信息</h4><font>65</font></span></td>
      <td><span style="color:green"><h4>已审信息</h4><font>65</font></span></td>
      <td><span style="color:red"><h4>退回信息</h4><font>65</font></span></td>
      </tr>
    </table>
</div>-->
<!--列表信息概况结束-->
 ...
 <table class="ui-table  ui-table-list  list-fixed  ">
      ...
      <#list displayInfo.fieldValueList as recordValueList >  
         ...
         <#assign seq = 1>
           ...
           <td><a href="javascript:opendg('datum/viewData.action?funcCode=${funcCode}&entityid=${keyColumn}',800,500)"  class="ui-btn ui-btn-normal" >查看</a></td>
...
<#assign totalPage = displayInfo.totalPage >
    ...
    <a href="../datum/gotoPublicList.action?funcCode=${funcCode}&pageNum=1" class="ui-page-item ui-page-item-first">首页</a>
    <#assign upPage = pageNum -1>
    <#if upPage <1 >
          <#assign upPage = 1>
        </#if>  
    <a href="../datum/gotoPublicList.action?funcCode=${funcCode}&pageNum=${upPage}" class="ui-page-item ui-page-item-prev">上一页</a>
    ...
    <a href="../datum/gotoPublicList.action?funcCode=${funcCode}&pageNum=${downPage}" class="ui-page-item ui-page-next">下一页</a>
    <a href="../datum/gotoPublicList.action?funcCode=${funcCode}&pageNum=${totalPage}" class="ui-page-item ui-page-last">尾页</a></span>
