...
统计说明：
				...
				-->												
				<#if xztjStat.auditPerson?exists>
				<tr>
					<td colspan="29">
						&nbsp;
					</td>
				...
				<tr>
					...
					<td colspan="19">
						<font color='red'>${xztjStat.auditIdea}</font>
					</td>
				</tr>
				...
				<tr>					
					...
					<td colspan="8">
						<font color='red'>${xztjStat.auditPerson}</font>
					</td>
					...
					<td colspan="6">
						<font color='red'>${xztjStat.auditDate}</font>
					</td>
				</tr>
				</#if>
				...
				<tr>
					<td rowspan="3" colspan="5">
						<#if xztjStat.auditPerson?exists>本次</#if>审核操作：
					</td>
					...
					<td colspan="19">
						<label><input id="r1" type="radio" class="" name="checkRadio" value="1" onclick="changeArrange(this.value)" checked/>通过</label>	
						
						<label><input id="r2" type="radio" class="" name="checkRadio" value="0" onclick="changeArrange(this.value)"/>退回</label>
					</td>
				</tr>
				
				<tr id="auditIdea" style="display:none">
					<td colspan="5">
						审核意见：
					</td>
					
					<td colspan="19">
						<textarea class="" id="auditIdea1" name="xztjStat.auditIdea"></textarea>
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="8">
						<input type="text" class="" name="xztjStat.auditPerson" value="${auditor}" style="width:80%"/>
						<input type="hidden" class="" name="xztjStat.auditId" value="${auditId}"/>
					</td>
					...
					<td colspan="6">
						<input type="text" class="" name="xztjStat.auditDate" value="${currentDate}" onClick="WdatePicker()" style="width:85%"/>
					</td>
				</tr>
...
//			document.getElementById("auditIdea").style.display="block";
	...
	function auditSubmitApp(){
		...
		if(document.getElementById("r2").checked == true){
			if($.trim($('#auditIdea1').val())==null ||　$.trim($('#auditIdea1').val())==　''){
				alert("请填写审核意见！");
				return;
			}
		}
