...
<form name="Form1" id="Form1" action="../xztj/gotoAudit.action" method="post" onreset>
      ...
      <div class="pageBox">
				...
				<#list xztjList as xztj>					
					<tr>
						...
						<#if xztj.status?has_content>
							<#if xztj.status != '0'>
								<div id="link"><a href="../xztj/viewXztjAuditRlt.action?funcCode=${funcCode}&id=${xztj.id}" target="_blank">查看</a></div>
							<#else>
								<#if xztj.appId == userId>
								<div id="link"><a href="../xztj/viewXztjAuditRlt.action?funcCode=${funcCode}&id=${xztj.id}" target="_blank">查看</a></div>
								<#else>
								<div id="link"><a href="../xztj/formalXztjAudit.action?funcCode=${funcCode}&id=${xztj.id}">审核</a></div>						
								</#if>
							</#if>
						</#if>
						</td>
            ...
            <div class="pageNum">
               第${pNum}/${totalPage}页   共${totalCount}条
				...
				<a href="../xztj/gotoAudit.action?pNum=1&funcCode=${funcCode}" class="ui-page-item ui-page-item-first">首页</a>
			    <a href="../xztj/gotoAudit.action?pNum=${upPage}&funcCode=${funcCode}" class="ui-page-item ui-page-item-prev">上一页</a>
		     	<a href="../xztj/gotoAudit.action?pNum=${downPage}&funcCode=${funcCode}" class="ui-page-item ui-page-next">下一页</a>
			    <a href="../xztj/gotoAudit.action?pNum=${totalPage}&funcCode=${funcCode}" class="ui-page-item ui-page-last">尾页</a>　
	...
	function goPage(pNum){		
		...
		function gotoPage(){
				...
				if(inputPage > ${totalPage}){
					...
					window.location = "../xztj/gotoAudit.action?funcCode=${funcCode}&pNum=" + inputPage;
				}
				return;
			}	
