...
<form name="Form1" id="Form1" action="../xztj/gotoCenterStatList.action" method="post" onreset>
      ...
      <div class="pageBox">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">            	 
				...
				<#list xztjList as xztj>					
					<tr>
						...
						<!--审核状态-->
						<td>&nbsp;
						<#if xztj.statPerfectOrNot?exists>
							<#if xztj.statPerfectOrNot == '0'>
								不完全
							<#else>
								完全
							</#if>
						...
						<!--审核or查看-->
						<td>
							<div id="link"><a href="../xztj/showDetailListOneByOne.action?funcCode=${funcCode}&id=${xztj.id}" target="_blank">查看</a></div>													
						</td>
            ...
            <div class="pageNum">
               第${pNum}/${totalPage}页   共${totalCount}条
				...
				<a href="../xztj/gotoCenterStatList.action?pNum=1&funcCode=${funcCode}" class="ui-page-item ui-page-item-first">首页</a>
			    <a href="../xztj/gotoCenterStatList.action?pNum=${upPage}&funcCode=${funcCode}" class="ui-page-item ui-page-item-prev">上一页</a>
		     	<a href="../xztj/gotoCenterStatList.action?pNum=${downPage}&funcCode=${funcCode}" class="ui-page-item ui-page-next">下一页</a>
			    <a href="../xztj/gotoCenterStatList.action?pNum=${totalPage}&funcCode=${funcCode}" class="ui-page-item ui-page-last">尾页</a>　
	...
	function goPage(pNum){		
		...
		function gotoPage(){
				...
				if(inputPage > ${totalPage}){
					...
					window.location = "../xztj/gotoCenterStatList.action?funcCode=${funcCode}&pNum=" + inputPage;
				}
				return;
			}	
	function addNewApp(){
