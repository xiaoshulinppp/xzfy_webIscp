...
<div class="wal">
      ...
      <div class="nav">
            <ul>
               <li class="li_01"><a href="" class="aNow">首页</a></li>
               <li class="li_02"><a href="">最新动态</a></li>
               <li class="li_03"><a href="">领导讲话</a></li>
               <li class="li_04"><a href="">法律法规</a></li>
               <li class="li_05"><a href="">资料分享</a></li>
...
<div class="fl w198">
      <div class="sideNav">
            ...
            <ul>
                 <li><a href="javascript:dangmian();" class="aNow">当面申请行政复议</a></li>
                 <li><a href="javascript:laixin();" >来信申请行政复议</a></li>
            </ul>
      </div>
      <div class="sideTip">
...
<div class="fr w739">
      <div class="pageNow">当前位置：当面申请行政复议</div>
      <div class="pageDiv" style="display:none">
            ...
            <div class="formDiv">
                  <div class="btn">
                       ...
                       <h1 class="fr"><a href="">行政复议申请材料处理</a></h1>
                  </div>
     ...
     <div class="pageDiv" style="display:block">
	    ...
	    onClick="WdatePicker()" altname="接待日期" value='${todate}' class="input2">
	      </td>
	    
	    <th width="25%">接待地点：</th>
		    <td width="25%">
		    <input name="xzfyInfo.receive_address" type="text" id="place" class="input2" >
		    </td>
  </tr>
    ...
    <tr >
  	<th>接待人：</td>
    <td >
    <input name="xzfyInfo.admit1" id="admit" type="text"  value="${admit_name}" ischeck="y"  altname="接待人" class="input2">    
   </td>
   <th>第二接待人：</td>
    <td>
    <input name="xzfyInfo.admit2" id="admit2" type="text" value="庞雷" altname="第二接待人" readonly class="input2">    
   </td>   
    </tr>	
...
<tr >
    ...
    <td><input name="xzfyInfo.jdRenshu" type="text"
     id="applicationsum" class="input2" altname="接待人数" >
   </td>  
</tr>
...
<tr >
   ...
   <tr >
	   ...
	   <th>申请人人数：</th>
    <td><input class="input2" name="xzfyInfo.renCount" id="rencount" onBlur="renCount()" onchange="setCountAppname('shenqingren','rencount')"   type="text"  altname="申请人人数"></td>
   </tr>
   <#--
    <tr  id="shenqingren1">
  	<th>申请人：</th>
...
<tr >
  ...
  <tr  style="display:none">
    ...
    <td><input name="app_face.TBeName" class="input2" id="xingwei" type="text"  altname="被复议的具体行为-名称"  title="请输入正确的名称"></td>
     <th>被复议的具体行为-案号：</th>
    <td><input name="app_face.annum" type="text" id="annum"  class="input2"  altname="案号" ></td>
  </tr>
   ...
   <td>
	...
	<tr >
	    ...
	    <td><input type="radio" name="xzfyInfo.ischeck" nbzcheck="y" altname="对规范性文件审查" value="是" id="gfsc_y" onclick="check_shencha('1')">
			...
			<input name="xzfyInfo.check_file" type="text" id="post2"  class="input2"></span>
	    </td>
...
<select name="xzfyInfo.app_advice_type" id="beadvice" onchange="setbjd()">
 ...
 <td>
	 ...
	 <th><span style="display:none;" id="senddept">转送机构名称：</span></td>
         ...
         <input name="app_face.TOtherDept" id="senddept3" type="text"  title="请输入正确的姓名，格式在20个汉字以内"></span></td>
	 </tr>
	 </tbody>
	 ...
	 <tr >
	 <th>笔录上传：</td>
	 <td  > <input name="file" type="file"  UNSELECTABLE="on"></td>
	  <th>&nbsp;</td>
	 <td  >&nbsp;</td>
	 </tr>-->
...
&nbsp因其他机关已受理，或法院已受理，不符合受理条件&nbsp<input name="xzfyInfo.reception2"  type="radio" altname="接待处理" value='4'  onclick="setJDCL(24)"><br>
 ...
 <div class="btn">
                       <div class="fl">
<a href="#" title="接待笔录"  onclick="javascript:saveDoc()">接待笔录</a>
<a href="#" title="生成收据"  onclick="javascript:saveDoc2()">生成收据</a>
<a href="#" title="送达地址确认单"  onclick="javascript:saveDoc3()" >地址确认单</a>
...
<tr>
<td id="txw">
<table  id="xwapp"class="z_info_table">
<tr><th>
被复议的具体行为-名称：
</td>
<td>
...
<td align="right"><a href="javascript:resetFile1()">不添加</a></td>
	...
	<table width="90%">
		<tr>
		<td id="tfile">
		<table  id="fileapp" isfilediv="1" class="z_info_table">
		<tr><th>
		文件名：
		</th>
...
<table width="90%" border='1' class="z_info_table">
...
var url="http://localhost:8080/webIscp/bac_document_edit.jsp?action=new&d_filetype=doc&d_templateid=20131021070651&d_username=${Session['_USER_LOGIN_'].id}&caseId=${xzfyId}";
	window.open(url,'mainwindow','location=no,resizable=yes');
}
