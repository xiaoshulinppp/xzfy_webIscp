...
<style type="text/css">img,form2,.form2{behavior: url(../webstyle/style/ie-css3.htc);} </style> 
<#--
...
<input id="xzfyId" name="xzfyInfo.id" value="${xzfyNewId}" type="hidden">
...
<input type="hidden" id="buzheng_from" name="xzfyInfo.buzheng_from" value="${xzfyInfo.buzheng_from?default('')}"> 
<input type="hidden" id="appshow" name="xzfyInfo.app_show" value="${xzfyInfo.app_show?default('')}">
<input type="hidden" name="xzfyInfo.receive_real_date" value="${xzfyInfo.receive_real_date?default('')}" />
...
<!--wal-->
 ...
 <div class="formTitle2">已接收复议材料当面补正</div>
	...
	<table >
		<tr >
			...
			<td width="35%">
				<input name="xzfyInfo.receive_date" type="text" id="receivedate"  ischeck="y" onClick="WdatePicker()" altname="接待日期" value='${todate[0..9]}' class="input2">
			</td>
		...
		<tr >
			...
			<td >
				<input name="xzfyInfo.admit1" id="admit" type="text"  value="${xzfyInfo.admit1?default('')}" ischeck="y"  altname="接待人" class="input2">    
			</td>
			<th>第二接待人：</th>
			<td>
				<input name="xzfyInfo.admit2" id="admit2" type="text" value="${xzfyInfo.admit2?default('')}"  altname="第二接待人" class="input2">    
			</td>   
		</tr>	
		 <tr >
    ...
    <td><input class="input2" ischeck="y" altname="申请人人数"  name="xzfyInfo.renCount" id="rencount" onBlur="renCount()" onchange="setCountAppname('shenqingren','rencount')"   type="text"  altname="申请人人数" value="${xzfyInfo.renCount?default('')}"></td>
   </tr>
  
   <tr  id="shenqingren1" <#if xzfyInfo.app_type=="2">style="display:none"</#if>>
  	<th ><font color="red">*</font>申请人：</th>
    <td  colspan=3>
    <a href="javascript:setApp('#appDiv',1)" style="display:block" id="appspan">添加</a>
    <textarea name="xzfyInfo.appdetail" type="text" style="border:0px"  class="textarea" onchange="setCountAppname('shenqingren','rencount')" id="shenqingren" ischeck="y" altname="申请人" style="overflow-y:visible;" readonly>${xzfyInfo.appdetail?default('')}</textarea>
    </td>
   </tr>
   
   <tr class="trwhite" id="sqr" <#if xzfyInfo.app_type=="1">style="display:none"</#if>>
    <th><font color="red">*</font>申请人名称：</th>
    <td colspan=3>
	<a href="javascript:setFr('#frDiv',1)" id="frspan" >添加</a><br>
    <textarea name="xzfyInfo.agentDetail" type="text" style="border:0px"  id="appname" class="textarea" ischeck="y" altname="法人" style="overflow-y:visible;" >${xzfyInfo.agentDetail?default('')}</textarea>
    </td>
   </tr>
		<tr >
			...
			<textarea name="xzfyInfo.jddetail" type="text" class="textarea"  id="user" ischeck="y" altname="被接待人" style="overflow-y:visible;">${xzfyInfo.jddetail?default('')}</textarea>
			</td>
			<th><font color="red">*</font>被接待人数：</th>
			<td><input name="xzfyInfo.jdRenshu" type="text" id="applicationsum" class="input2" ischeck="y" altname="接待人数" value="${xzfyInfo.jdRenshu?default('')}">
			</td>  
		</tr>
	<tr style="display:none">
	<th><font color="red">*</font>接待目的：</th>
	<td> <select name="jiedaimudi" id="jiedaimudi" >
		    	<option value="0">--请选择--</option>
				<option value="1">了解情况</option>
		    	<option value="2">明确有关事项</option>
		    	<option value="3" selected>补正材料</option>
	</select>
	</td>
	<th></th>
	<td> 
	...
	<tr>
	<th><font color="red">*</font>首次收到申请材料时间：</th>
	<td><input name="shoudaoshijian" type="text"
	     id="shoudaoshijian"  value="${xzfyInfo.receive_date}"
	    onClick="WdatePicker()"  class="input2"></td>
	<th><font color="red">*</font>首次收到申请材料方式：</th>
	<td><select name="shoudaofangshi" id="shoudaofangshi" >
		    	<option value="1" <#if xzfyInfo.app_type=='1'>selected</#if>>当面</option>
				<option value="2"  <#if xzfyInfo.app_type=='2'>selected</#if>>来信</option>
		    	<option value="3"  <#if xzfyInfo.app_type=='3'>selected</#if>>电子邮件</option>
		    	<option value="4"  <#if xzfyInfo.app_type=='4'>selected</#if>>其他方式</option>
	</select></td>
	</tr>
		<tr  style="display:none">
			<th>多人复议：</td>
			<td>
			<input name="xzfyInfo.isMany" id="duoren_y" value="否" class="input2" value="${xzfyInfo.isMany?default('')}">
			</td>
		</tr>
		<tr >
	<th><font color="red">*</font>涉及安全：</th>
    <td  colspan=3>
        <input name="xzfyInfo.issafe" id="anquany_y"  value="是" onclick="setAqf(1)" type="radio" <#if xzfyInfo.issafe?default('否')=="是">checked</#if>><label for="isting_y">是</label>
        <input name="xzfyInfo.issafe" id="anquany_n"  value="否" onclick="setAqf(2)" type="radio"  <#if xzfyInfo.issafe?default('否')=="否">checked</#if>><label for="isting_n">否</label>
        <span id="aqspan"   <#if xzfyInfo.issafe?default('否') == "否"> style="display:none"</#if>>
		  <a href="javascript:setAqf(1)">添加</a><br>
		  <textarea name="xzfyInfo.safeContent" type="text" class="textarea"  id="aqcontent" altname="安全隐患" style="overflow-y:visible;" onchange="textCounter(this.form.comment,1000);">${xzfyInfo.safeContent?default('')}</textarea>
		</span>
    </td>
</tr>
   <input type="hidden" id="tiqu" value="1">
   <tr id="daibiaorendiv" <#if !xzfyInfo.dbrDetail?has_content>style="display:none"</#if>> 
	<th><font color="red">*</font>代表人：</th>
	<td  colspan=3>
		  <a href="javascript:setDeputy('#deputyDiv',1)" style="display:block" id="deputyspan">添加</a>
    	<textarea name="xzfyInfo.dbrDetail" type="text" class="textarea"  id="deputy" ischeck="y" altname="代表人" style="overflow-y:visible;" >${xzfyInfo.dbrDetail?default('')}</textarea>
	</td>	    
   </tr>
  ...
  <tr >
   <th><font color="red">*</font>是否有代理人：</th>
    <td>
     <input name="xzfyInfo.agent" id="isdlr_y"  value="1" onclick="checkdlr(1)" type="radio" <#if xzfyInfo.agent?default('0')=="1">checked</#if>><label for="isdlr_y">有</label>
        <input name="xzfyInfo.agent" id="isdlr_n"  value="0" onclick="checkdlr(0)" type="radio" <#if xzfyInfo.agent?default('0')=="0">checked</#if>><label for="isdlr_n">无</label>
        
     <input type="hidden" id="isdlr" value="${xzfyInfo.agent?default('')}">
    </td>
   <th><font color="red">*</font>是否申请行政赔偿：</td>
  <td  >
 <input type="radio" name="xzfyInfo.ismoney" <#if xzfyInfo.ismoney=="是">checked</#if> value="是" id="peichang_y" ischeck="y" altname="是否行政赔偿" onclick="check_pc(1)">
		      <label for="peichang_y">是</label>
		      <input type="radio" <#if xzfyInfo.ismoney=="否">checked</#if> name="xzfyInfo.ismoney" value="否" id="peichang_n" ischeck="y" altname="是否行政赔偿" onclick="check_pc(2)">
		      <label for="peichang_n">否</label>

  </td>
  </tr>	
  <tr  <#if xzfyInfo.ismoney=="否">style="display:none"</#if>  id="peichang_div">
	  <th>赔偿金额：</td>
	    <td>
	   ...
	   <th>受损证明材料：</td>
  <td  >
  <textarea name="xzfyInfo.money_file" id="peichang_file" class="textarea" style="overflow-y:visible;">${xzfyInfo.money_file?default('')}</textarea>

  </td>
    </tr>
   <tr id="jddlr" <#if xzfyInfo.agent?default('0') == "0"> style="display:none" </#if>>
    <th>委托代理人姓名：</th>
    <td>
    <input name="xzfyInfo.agent_name" type="text" id="dlrname"
     altname="委托代理人姓名项" class="input2" value="${xzfyInfo.agent_name?default('')}"></td>
    <th>是否有授权委托书：</th>
    <td>
	     <input name="xzfyInfo.proxy" id="dlrsq_y"  value="1"  type="radio" <#if xzfyInfo.proxy?default('0')=="1">checked</#if>><label for="dlrsq_y">有</label>
        <input name="xzfyInfo.proxy" id="dlrsq_n"  value="0"  type="radio" <#if xzfyInfo.proxy?default('0')=="0">checked</#if>><label for="dlrsq_n">无</label>
	</td>
    </tr>
   <tr class="trwhite" id="jddlr1" <#if xzfyInfo.proxy?default('0') != "3"> style="display:none" </#if>>
    <th>委托时间：</th>
    <td>
     <input name="xzfyInfo.agent_date" type="text" id="wtsj" class="input2" value="${xzfyInfo.agent_date?default('')}">
    ...
    <input name="xzfyInfo.agent_address" type="text" id="wtdd"
     altname="地点" class="input2" value="${xzfyInfo.agent_address?default('')}"></td>
    </tr>
<input type="hidden" value="0" id="aac">
<tr >
    <th><font color="red">*</font>被申请人种类：</th>
   <td >
  <select name="xzfyInfo.defendant_type" id="beapptype" onchange="aaa()" onclick="aaa()">
    <option value="0">--请选择--</option>
	<#list zlList as zl>
	<option value="${zl.value}" <#if zl.value==xzfyInfo.defendant_type>selected</#if>>${zl.name}</option>
     ...
     <td  style="display:block;" id="beappnametd" width="25%">   
  ...
  <tr  id="mingan">
    ...
    <td>
     <input name="xzfyInfo.ismanage" id="requestrrr_y"  value="2" onclick="szfyqq(2)" type="radio" <#if xzfyInfo.ismanage?default('0')=="2">checked</#if>><label for="requestrrr_y">是</label>
        <input name="xzfyInfo.ismanage" id="requestrrr_n"  value="0" onclick="szfyqq(0)" type="radio" <#if xzfyInfo.ismanage?default('0')=="0">checked</#if>><label for="requestrrr_n">否</label>
        <input type="hidden" id="requestrrr" value="${xzfyInfo.ismanage?default('')}">
   
	</td>
     <th><font color="red">*</font>要求复议的具体行政行为情况：</th>
	    <td>
	      <a href="javascript:getBzw()" id="getBzw" style="display:none">添加 </a>
  	 	  <a href="javascript:closeBzw()" id="closeBzw" <#if xzfyInfo.ismanage?default('0')!="2">style="display:none"</#if>>完成 </a>
		  <span id='xwspan' <#if xzfyInfo.ismanage?default('0')=="2">style="display:none"</#if>><a href="javascript:openXw('#xwDiv')" >添加</a></span>
		  <span id="xw_an">
  ...
  <tr  style="display:none">
    <th>被复议的具体行为-名称：</th>
    <td><input name="app_face.shenqingrenplace" id="xingwei1" value="${xzfyInfo.xwname?default('')}" type="text" class="input2"></td>
     <th>知道时间：</th>
    <td><input name="app_face.renpost" type="text" id="xingwei2" value="${xzfyInfo.xwnum?default('')}" class="input2" ></td>
  </tr>
  ...
  <tr class="trwhite" id="requesttype2"  <#if xzfyInfo.ismanage?default('0')=="0"> style="display:none"</#if>>
   <th>不作为事项：</td>
   <td>
	  <select name="xzfyInfo.matter_type" id="use_type"  onchange="setBzw()">
	         <option value="0">----请选择----</option>
		 <option value="不颁发证照" <#if xzfyInfo.matter_type?exists&&xzfyInfo.matter_type=="不颁发证照">selected</#if>>不颁发证照</option>
		 <option value="不审批登记" <#if xzfyInfo.matter_type?exists&&xzfyInfo.matter_type=="不审批登记">selected</#if>>不审批登记</option>
		 <option value="不保护人身权" <#if xzfyInfo.matter_type?exists&&xzfyInfo.matter_type=="不保护人身权">selected</#if>>不保护人身权</option>
		 <option value="不保护其他财产权" <#if xzfyInfo.matter_type?exists&&xzfyInfo.matter_type=="不保护其他财产权">selected</#if>>不保护其他财产权</option>
		 <option value="不保护受教育权" <#if xzfyInfo.matter_type?exists&&xzfyInfo.matter_type=="不保护受教育权">selected</#if>>不保护受教育权</option>
		 <option value="不发放抚恤金" <#if xzfyInfo.matter_type?exists&&xzfyInfo.matter_type=="不发放抚恤金">selected</#if>>不发放抚恤金</option>
		 <option value="不发放社会保险金" <#if xzfyInfo.matter_type?exists&&xzfyInfo.matter_type=="不发放社会保险金">selected</#if>>不发放社会保险金</option>
		 <option value="不发放最低生活保障费" <#if xzfyInfo.matter_type?exists&&xzfyInfo.matter_type=="不发放最低生活保障费">selected</#if>>不发放最低生活保障费</option>
		 <option value="不履行信息公开职责" <#if xzfyInfo.matter_type?exists&&xzfyInfo.matter_type=="不履行信息公开职责">selected</#if>>不履行信息公开职责</option>
		 <option value="其他" <#if xzfyInfo.matter_type?exists&&xzfyInfo.matter_type=="其他">selected</#if>>其他</option>
	  </select>
	  <textarea class="textarea" name="xzfyInfo.matter_detail" id="bzwbc" style="overflow-y:visible;">${xzfyInfo.matter_detail?default('')}</textarea>
	   ...
	   <select name="xzfyInfo.is_prof" id="ismingque" onchange="ryq2()">
	    <option value="0">----请选择----</option>
	      <option value="有" <#if xzfyInfo.is_prof?default('')=="有">selected</#if>>有</option>
		 <option value="无" <#if xzfyInfo.is_prof?default('')=="无">selected</#if>>无</option>
	  </select>
	    <textarea name="xzfyInfo.is_prof_detail" id="mingque" class="textarea" >${xzfyInfo.is_prof_detail?default('')}</textarea>
	      </td>
   </tr>    
   <tr  id="requesttype3"  <#if xzfyInfo.ismanage?default('0')=="0"> style="display:none"</#if>>
	    <th>要求被申请人履行日期：</th>
	    <td>
	    <input name="xzfyInfo.execute_date" type="text"
		     id="usedate" 
		      altname="要求被申请人履行日期" class="input2" value="${xzfyInfo.execute_date?default('')}"><br>
 ...
 <th><font color="red">*</font>行政复议请求：
   ...
   <td  ><@ww.select  name="'xzfyInfo.xzfy_requset'" id="request2yiban" headerKey="'0'" headerValue="'--请选择--'"  list="getDictMap('xzfyqq')" onchange="'ryq();closeBzw1()'" value="'${xzfyInfo.xzfy_requset?default('')}'.toString()"/>
    <textarea name="xzfyInfo.xzfy_requset_retail" id="xzfyqq1" type="text"  style="overflow-y:visible;" class="textarea" altname="行政复议请求" onchange="closeBzw1()">${xzfyInfo.xzfy_requset_retail?default('')}</textarea>
  </td>
	  <th>是否申请听证：</td>
	    <td>
	    	  <input type="radio" <#if xzfyInfo.istingzheng=="是">checked</#if> name="xzfyInfo.istingzheng" value="是" id="tingzheng_y" ischeck="y" altname="是否听证">
		      <label for="isting_y">是</label>
		      <input type="radio" <#if xzfyInfo.istingzheng=="否">checked</#if> name="xzfyInfo.istingzheng" value="否" id="tingzheng_n" ischeck="y" altname="是否听证">
 ...
 <tbody id="check_select" style="display:none">
  <tr >
    <th>接待类别：</td>
    <td>
<select class="selectStyleNormal" retSelect="1">
      <option value="0">----请选择----</option>
   ...
   <td>
	...
	<tr >
		...
		<th>复议前置：</td>
	    <td>
		    <input type="radio" name="xzfyInfo.isfront" value="是" id="fyqz_y" ischeck="y" <#if xzfyInfo.isfront=="是">checked</#if> altname="复议前置">
		        <label for="fyqz_y">是 </label>
		     <input type="radio" name="xzfyInfo.isfront" value="否" id="fyqz_n" ischeck="y" <#if xzfyInfo.isfront=="否">checked</#if> altname="复议前置">
	        <label for="fyqz_n">否</label>
        </td>
        
        <th>是否申请对规范性<br>文件审查：</th>
	    <td><input type="radio" name="xzfyInfo.ischeck" nbzcheck="y" altname="对规范性文件审查" value="是" id="gfsc_y" onclick="check_shencha('1')" <#if xzfyInfo.ischeck=="是">checked</#if>>
	        <label for="gfsc_y">是 </label>
	        <input type="radio" name="xzfyInfo.ischeck" altname="对规范性文件审查" value="否" nbzcheck="y"  id="gfsc_n" <#if xzfyInfo.ischeck=="否">checked</#if> onclick="check_shencha('2')">
	        <label for="gfsc_n">否</label>
			<span id="shencha" <#if xzfyInfo.ischeck=="否">style="display:none"</#if> >规范文件：
			<textarea name="xzfyInfo.check_file" id="post2" class='textarea'>${xzfyInfo.check_file?default('')}</textarea></span>
	    </td>
	</tr>
  </tr>
  ...
  <tr >
  		...
  		<th>是否愿意接受调解：</td>
    <td>
    <@ww.select name="'xzfyInfo.istiaojie'" id="tiaojie" headerKey="" headerValue="" value="'${xzfyInfo.istiaojie?default('3')}'.toString()" list="getDictMap('sftj')" onchange="'showTiaojie();;closeBzw1()'"/>
   
    </td>
    
	<th>其他复议机关、法院是否受理同一复议申请：</td>
    <td>
    <input type="radio" name="xzfyInfo.issame"  value="是" id="isshouli_y" <#if xzfyInfo.issame?default('否')=="是">checked</#if> onclick="check_qtfyjg('1')">
	        <label for="isshouli_y">是 </label>
	<input type="radio" name="xzfyInfo.issame"  value="否"  id="isshouli_n" <#if xzfyInfo.issame?default('否')=="否">checked</#if> onclick="check_qtfyjg('0')">
	        <label for="isshouli_n">否</label>
    <br>
     <span id="qtfyjg"  <#if xzfyInfo.issame?default('否')=="否">style="display:none"</#if>>
    <textarea name="xzfyInfo.issame_detail" class="textarea" id="shuoming" style="overflow-y:visible;" altname="说明">${xzfyInfo.issame_detail?default('')}</textarea>
    </span>
    </td>
</tr>

 <tbody id="otherDetail" <#if xzfyInfo.istiaojie?default('0') != "1">style="display:none"</#if>>	  
	  <tr  >
...
<a href="javascript:updateFile()" style="display:block" id="filespan">接收材料</a>
  ...
  <textarea name="xzfyInfo.jdFileContent" id="filedetail" type="text" class='textarea' style="overflow-y:visible;display:block">由于申请人今天补齐申请材料，我们从今日起计算行政复议受理审查和案件审理期限，并将依法处理。</textarea>
 
</td> 
 <th>被接待人意见：<br>(鼠标双击添加对话)</td>
    <td>   
    <textarea name="xzfyInfo.app_advice_detail" id="otheradvice" class="textarea" style="overflow-y:visible;" altname="意见" ondblclick="getValue1(this)">${xzfyInfo.app_advice_detail?default('答：同意。')}</textarea>
    </td>
 </tr>
...
<div border="0" >
	<div class="btn" >
	<div class="fl" >
		<a href="#" title="请在页面上修改案件基本信息，其他接待记录可以直接在笔录上修改。您在笔录上所做修改，不会自动在页面上改动"  id="getDocType"  onclick="javascript:getDocType();return false;">接待笔录</a>
		<a href="#" title="请根据本单位实际要求使用"  onclick="javascript:saveDoc2();return false;">生成收据</a>
		<a href="#" title="送达地址确认单"  onclick="javascript:saveDoc3();return false;" >地址确认单</a>
...
申请人：</th>
<td colspan=3>
<input name="frsqr" isUser="true" onchange="checkComma(this)" size="50" value="${app.app_name?default('')}"/>
</td>
</tr>
<tr>
<th>
...
<option value="法定代表人" <#if app.deputyType?exists&&app.deputyType=="法定代表人">selected</#if>>法定代表人</option>
	<option value="负责人" <#if app.deputyType?exists&&app.deputyType=="负责人">selected</#if>>负责人</option>
    <option value="执行合伙事务的合伙人" <#if app.deputyType?exists&&app.deputyType=="执行合伙事务的合伙人">selected</#if>>执行合伙事务的合伙人</option>
    <option value="合伙人" <#if app.deputyType?exists&&app.deputyType=="合伙人">selected</#if>>合伙人</option>
    <option value="主要负责人" <#if app.deputyType?exists&&app.deputyType=="主要负责人">selected</#if>>主要负责人</option>
    <option value="被共同推选的非法人组织其他成员" <#if app.deputyType?exists&&app.deputyType=="被共同推选的非法人组织其他成员">selected</#if>>被共同推选的非法人组织其他成员</option>
	</select>
...
<td width="32%"><input name="fuzeren" onchange="checkComma(this)" isUser="true" value="${app.deputyName?default('')}"/>
</td>
...
<th width="18%">
	送达地址：</th>
<td width="32%">
<textarea name="fzraddress" onchange="checkComma(this)" isUser="true" >${app.mail_address?default('')}</textarea>
<!--<input name="fzraddress" isUser="true" value="" size=30/>-->
	</td>	
	<th>
	邮编：</th>
<td><input name="fzrpost" onchange="checkComma(this)" isUser="true" value="${app.postcode?default('')}"/>
	</td>
	</tr>
	<tr>
	...
	<th>
	电话：</th>
<td><input name="fzrtele" onchange="checkComma(this)" isUser="true" value="${app.telephone?default('')}"/>
	</td>
</tr>
<tr>
<th>
...
申请人：</th>
<td colspan=3>
<input name="frsqr" isUser="true" onchange="checkComma(this)" size="50" value=""/>
</td>
</tr>
<tr>
<th>
...
<td width="32%"><input name="fuzeren" onchange="checkComma(this)" isUser="true" value=""/>
</td>
...
<table  id="xwapp">
	<tr>
		...
		<td>
		<input name="xzfyInfo.xwname" isUser="true"  value="${xw.xwName?default('')}" />
		</td>
	</tr>
	<tr>
		<th>被复议的具体行为-文号：</th>
		<td>
			<input name="xzfyInfo.xwnum" isUser="true"  value='${xw.xwNum?default('')}'  />&nbsp;<!--<a href="#" onclick="anNumConfirm();return false;" title="检测重复"  >检测重复</a>-->
		</td>
	</tr>
<tr>
<th>
...
<table  id="xwapp">
	...
	<tr>
		<th>被复议的具体行为-文号：</th>
		<td>
			<input name="xzfyInfo.xwnum" isUser="true"  value=''  />
		</td>
	</tr>
	<tr>
		<th>
		...
		<td><input name="anNumYear"  id="anNumYear" class="inputTextSmall" style="WIDTH:70px;" value='' >-<input name="anNumAdd"  id="anNumAdd" class="inputTextSmall" style="WIDTH:70px;" value='' >
		<a href="#" onclick="anNumConfirm();return false;" title="检测重复"  >检测重复</a>
		</td>
	</tr>
<tr>
<th>
...
<tr>
<th>申请人：</th>
<td><input name="appsqr" isUser="true" onchange="checkComma(this)" value="${app.app_name?default('')}"/></td>
<th>性别：</th>
...
<tr>
	<th>身份证号：</th>
	<td><input name="appnum" isUser="true" onchange="checkComma(this)" value="${app.app_id?default('')}" />
	</td>
	<th>
	送达地址：
	</th>
	<td>
	<textarea name="appaddress" type="text" onchange="checkComma(this)" isUser="true">${app.mail_address?default('')}</textarea>
	</td>
</tr>
<tr>
	<th>
	...
	<td><input name="apppost" onchange="checkComma(this)" isUser="true" value="${app.postcode?default('')}"/>
	</td>
	<th>
	电话：
	</th>
	<td><input name="appphone" onchange="checkComma(this)" isUser="true" value="${app.telephone?default('')}" />
...
<th>性别：</th>
<td><select name="appsex" onchange="checkComma(this)" isUser="true" retSelect="1" style="display:block">
...
<table   id="dep" style="width:600px;">
	<tr style="width:600px;">
		...
		<td id="xuandbr">
			<#list xzfyInfo.xzfyApps as app>
			${app.app_name?default('')}&nbsp;&nbsp;<input type='checkbox' name='depsqr' id='deputySqr' value="${app.app_name?default('')}" <#if app.isdeputy=="1">checked</#if>/>
			</#list>
		</td>
	</tr>
</table>
...
<script>
	...
	var userString="我们今天接收你提交的下列申请材料，由于申请人今天补齐申请材料或者明确有关内容，我们从今日起计算行政复议受理审查和案件审理期限，并将依法处理：\n";
	if(document.getElementById("applicationsum").value>1){
		if(document.getElementById("jiedaimudi").value==2)
			userString="我们今天接收你们提交的下列申请材料，由于申请人今天明确有关内容，我们从今日起计算行政复议受理审查和案件审理期限，并将依法处理：\n";
		else
			userString="我们今天接收你们提交的下列申请材料，由于申请人今天补齐申请材料，我们从今日起计算行政复议受理审查和案件审理期限，并将依法处理：\n";
	}else{
		if(document.getElementById("jiedaimudi").value==2)
			userString="我们今天接收你提交的下列申请材料，由于申请人今天明确有关内容，我们从今日起计算行政复议受理审查和案件审理期限，并将依法处理：\n";
		else
			userString="我们今天接收你提交的下列申请材料，由于申请人今天补齐申请材料，我们从今日起计算行政复议受理审查和案件审理期限，并将依法处理：\n";	
	}
...
function resetFile1b(){
	if(document.getElementById("jiedaimudi").value==2)
		document.getElementById("filedetail").value="由于申请人今天明确有关内容，我们从今日起计算行政复议受理审查和案件审理期限，并将依法处理。";
	else
		document.getElementById("filedetail").value="由于申请人今天补齐申请材料，我们从今日起计算行政复议受理审查和案件审理期限，并将依法处理。";
	document.getElementById("fileDiv").style.display="none";
...
<div id="fileDiv" style="position:absolute;display:none;width:800px" class="formDiv">
	<div class="btn">
		...
		<div class="fr">
		<a href="javascript:closeFileb()">完成</a>
		<a href="javascript:resetFile1b()">不添加</a>
		</div>
	</div>
...
document.getElementById("appname").value==""	
	...
	/*
	if(document.getElementById("jiedaimudi").value=="0") {
		alert("请填写接待目的!");return;
	}
	*/
	if(document.getElementById("shoudaoshijian").value=="") {
		alert("请填写首次收到申请材料时间!");return;
	}
...
function saveNew(id){ 
    ...
    if(checknull()){
		...
		listForm_.action="../xzfy/saveFace1.action?funcCode=${funcCode}&&xzfyId=" + id;
			if(confirm("您确认提交吗?"))
			listForm_.submit();
	}
}
...
function check_shencha(idValue){
 ...
 function ajgllb(){
  ...
  function anNumConfirm(){
 	...
 	var dname="";
 	if (document.getElementById("aac").value=="1") {
	...
	} else if (document.getElementById("aac").value=="0"){
		dname = document.getElementById("beappnameinput").value;
	}
...
function getDocType(){
	...
	*/
	//if(confirm("您确认要生成吗？")){
		//var timed=Math.floor(Math.random()*5000); 
		//document.getElementById("getDocType").style.display="none";
...
function callbackfun1(){
	var url ="../fzb_default_dafutongzhi.jsp?&d_filetype=doc&d_username=${Session['_USER_LOGIN_'].id}&caseId=${xzfyNewId}&mstype=buzhengshouju";
...
function callbackfun2(){
	var url ="../fzb_default_dafutongzhijiean.jsp?&d_filetype=doc&d_username=${Session['_USER_LOGIN_'].id}&caseId=${xzfyNewId}&mstype=bilubuzheng&finish_type=${xzfyInfo.id}";
	window.open(url);
}
...
function callbackfun3(){
	var url ="../fzb_default_dafutongzhi.jsp?&d_filetype=doc&d_username=${Session['_USER_LOGIN_'].id}&caseId=${xzfyNewId}&mstype=songdadizhiquerenshu";
