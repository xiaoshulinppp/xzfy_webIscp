...
<#assign isBuzheng=xzfyInfo.isBuzhengshenpi?default('0')>
    ...
    <#if xzfyInfo.id.length() gt 10>
              ...
              <#assign sdResult=xzfyInfo.stadardResult?default('0')>    	
                  ...
                  <!-- <li><a href="javascript:;checkIframe('logDiv2','ifm1')" >案件录入记录</a></li>-->
                  </#if>
...
<input type="hidden" id="logDiv2" value="../xzfy/showLogList2.action?funcCode=${funcCode}&xzfyId=${xzfyInfo.id}">
