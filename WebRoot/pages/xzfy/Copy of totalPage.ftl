...
<div style="width:33%;float:left;">
 <table class="ui-table ui-table-comlist  list-fixed">
 <tr >
             <td colspan="10"><span >已有${totalCount4}个待审批记录</span>
             </td>
             </tr>
</table>
...
<div style="width:33%;float:left;">
 <table class="ui-table ui-table-comlist  list-fixed">
 <tr >
             <td colspan="10"><span >已有${totalCount3}个待办理记录</span>
             </td>
             </tr>
</table>
...
<div style="width:33%;float:left;">
 <table class="ui-table ui-table-comlist  list-fixed">
 <tr >
             <td colspan="10"><span >您已有${totalCount2}个待立案审查记录</span>
             </td>
             </tr>
</table>
