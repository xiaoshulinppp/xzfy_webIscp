...
<style type="text/css">
.indexPart4_1{height:261px; overflow:hidden; background:#f7f7f7;}
.indexPart4_1 .wal{padding-top:0px;}
.indexPart4_03_1{background:url(../image/indexPart4_03.png) left top no-repeat; float:left; height:257px; overflow:hidden; position:relative;}
.indexPart4_03_1 .list1{width:1000px; float:left; overflow:hidden; position:relative; right:3px; padding-top:5px;}
.indexPart4_03_1 .list1 ul{width:100%;}
.indexPart4_03_1 .list1 li{float:left; width:1000px; height:222px; overflow:hidden; border-right:#d3d3d3 dotted 1px; padding-top:3px;}
.fr{float:right;}

.indexPart4_03 .list li{float:left; text-align:center; width:353px; height:222px; overflow:hidden; border-right:#d3d3d3 dotted 1px; padding-top:3px;}

.indexPart4_03 .list2{line-height: 25px;padding: 3px 5px;}
.indexPart4_03 .list2 li{padding-left: 20px;background: url(../webstyle/image/ico4.gif) 10px center no-repeat;font-size: 12px;height: 20px;text-align: left;}

.indexPart4{height:562px; overflow:hidden; background:#f7f7f7;}
.indexPart4 .wal{padding-top:26px;}
/**/



.indexPart4_01_5 .list{line-height:25px; padding:3px 5px;}
.indexPart4_01_5 .list li{padding-left:20px; background:url(../image/ico4.gif) 10px center no-repeat;font-size:12px;}
...
<div class="wal">
      <div class="fl indexPart3_01">
            <ul>
              <li><a href="../xzss/showUndertakerList.action?funcCode=${funcCode}" >
...
<div class="wal">
      ...
      <div class="indexPart4_03">
        ...
        3. 本年度全市各级行政复议机关已受理复议案件<font color="red" >${acceptedFuYiCases}</font>件，驳回<font color="red" >${reject}</font>件，维持<font color="red" >${preserve}</font>件，确认违法<font color="red" >${illegal}</font>件，撤销<font color="red" >${revocation}</font>件，变更<font color="red" >${mofify}</font>件，责令履行<font color="red" >${executionInOrder}</font>件，调解<font color="red" >${reconciliation}</font>件，终止<font color="red" >${termination}</font>件，其它<font color="red" >${otherDeals}</font>件。
                  ...
                  <ul>
                    <li>
                          ...
                          <script type="text/javascript">
				              ...
				              chartx.setDataXML("<chart caption='本年度全市各区县人民政府受理情况统计aa' xAxisName='' yAxisName='' showValues='1' decimals='0' formatNumberScale='0' baseFontSize='14' outCnvBaseFontSize='14'><set label='东城区' value='30' link='../xzfy/showDetailChart1.action?funcCode=${funcCode}'/><set label='西城区' value='26' link='../xzfy/showDetailChart1.action?funcCode=${funcCode}'/><set label='朝阳区' value='20' link='../xzfy/showDetailChart1.action?funcCode=${funcCode}'/><set label='海淀区' value='20' link='../xzfy/showDetailChart1.action?funcCode=${funcCode}'/><set label='丰台区' value='18' link='../xzfy/showDetailChart1.action?funcCode=${funcCode}'/><set label='石景山区' value='16' link='../xzfy/showDetailChart1.action?funcCode=${funcCode}'/><set label='门头沟区' value='13' link='../xzfy/showDetailChart1.action?funcCode=${funcCode}'/><set label='房山区' value='8' link='../xzfy/showDetailChart1.action?funcCode=${funcCode}'/><set label='通州区' value='7' link='../xzfy/showDetailChart1.action?funcCode=${funcCode}'/><set label='顺义区' value='5' link='../xzfy/showDetailChart1.action?funcCode=${funcCode}'/><set label='大兴区' value='5' link='../xzfy/showDetailChart1.action?funcCode=${funcCode}'/><set label='昌平区' value='5' link='../xzfy/showDetailChart1.action?funcCode=${funcCode}'/><set label='平谷区' value='4' link='../xzfy/showDetailChart1.action?funcCode=${funcCode}'/><set label='怀柔区' value='3' link='../xzfy/showDetailChart1.action?funcCode=${funcCode}'/><set label='密云县' value='3' link='../xzfy/showDetailChart1.action?funcCode=${funcCode}'/><set label='延庆县' value='2' link='../xzfy/showDetailChart1.action?funcCode=${funcCode}'/></chart>");	
            ...
            <li>
                <div class="fl indexPart4_01">
            <div class="title"><h1>法律法规</h1></div>
            <a href="../website/subColumnMore.action?funcCode=${funcCode}&column=3&subColumn=31" target="blank" class="more"  style="color: #589358" >更多</a>
            <div class="list2">
                <ul>
                <#list articleInfoList4 as data>
                 <li><a href="../website/showArticle.action?funcCode=${funcCode}&articleId=${data.id}" title="${data.title?default('')}" target="blank">
...
<div class="indexPart4_1">
<div class="wal">
      <div class="indexPart4_03_1">
            <div class="list1" >
                  <ul>
                    <li>
                         <div class="" id="Divx2"><img src="../images/index/weiban.png"></div>
                         <script type="text/javascript">
				              var chartx= new FusionCharts("../pages/fusionCharts/chartsflash/Column2D.swf", "Divx1", "1000", "220", "0", "0");
...
<div class="foot">
版权所有：北京市人民政府法制办　地址：北京市西城区槐柏树街2号b<br />
电话：65193431
</div>
</body>
</html>