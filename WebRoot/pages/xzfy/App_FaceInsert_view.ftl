...
<div class="wal pageNow2">
      <div class="fl">当前位置：&nbsp;&nbsp;<a href="../xzfy/gotoIndex.action?funcCode=${funcCode}">首页  </a> >&nbsp;&nbsp;  <a href="../xzfy/openReceive.action?funcCode=${funcCode}">接收/新增案件</a>  >&nbsp;&nbsp;<a href="../xzfy/appFYfaceInsert.action?funcCode=${funcCode}">当面接待</a> >&nbsp;&nbsp; 案件详细信息  </div>
