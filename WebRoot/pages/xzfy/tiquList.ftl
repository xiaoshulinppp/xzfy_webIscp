...
<form name="Form1" id="Form1" action="../xzfy/buzhengFace.action" method="post">
      ...
      <div class="pageBox">
            ...
            <div class="pageNum">
               第${pageNum}/${totalPage}页   共${list.getTotalCount()}条
				...
				<a href="../xzfy/buzhengFace.action?pageNum=1&funcCode=${funcCode}" class="ui-page-item ui-page-item-first">首页</a>
			    <a href="../xzfy/buzhengFace.action?pageNum=${upPage}&funcCode=${funcCode}" class="ui-page-item ui-page-item-prev">上一页</a>
		     	<a href="../xzfy/buzhengFace.action?pageNum=${downPage}&funcCode=${funcCode}" class="ui-page-item ui-page-next">下一页</a>
			    <a href="../xzfy/buzhengFace.action?pageNum=${totalPage}&funcCode=${funcCode}" class="ui-page-item ui-page-last">尾页</a>　
...
<script>
		function tiqu(id) {
		window.location = "../xzfy/tiquFace.action?funcCode=${funcCode}&xzfyId="+id;
		}
		...
		function gotoPage(){
				...
				if(inputPage > ${totalPage}){
					...
					window.location = "../xzfy/buzhengFace.action?funcCode=${funcCode}&pageNum=" + inputPage;
				}
				return;
			}
