...
<tr >
    ...
    <th width="20%">接待地点：</th>
	    <td width="30%">
	    <input name="xzfyInfo.receive_address" type="text" id="place" value="${xzfyInfo.receive_address?default('')}">
	    </td>
  </tr>
    ...
    <tr >
  	<th>接待人：</td>
    <td >
    <input name="xzfyInfo.admit1" id="admit" type="text"  value="${xzfyInfo.admit1?default('')}" ischeck="y"  altname="接待人">    
   </td>
   <th>第二接待人：</td>
    <td>
    <input name="xzfyInfo.admit2" id="admit2" type="text" value="庞雷" altname="第二接待人" value="${xzfyInfo.admit2?default('')}" readonly>    
   </td>   
    </tr>	
...
<tr >
    ...
    <td><input name="xzfyInfo.jdRenshu" type="text"
     id="applicationsum" class="inputTextNormal required validate-digits" altname="接待人数" value="${xzfyInfo.jdRenshu?default('')}">
   </td>  
</tr>
...
<tr  style="display:none">
   <th>多人复议：</td>
    <td>
    <input name="xzfyInfo.isMany" id="duoren_y" value="否" value="${xzfyInfo.isMany?default('')}">
    </td>
</tr>
<tr >
	<th>涉及安全：</th>
    <td  colspan=3>
        <input name="xzfyInfo.issafe" id="anquany_y"  value="是" onclick="setAqf(1)" type="radio" class="radio" <#if xzfyInfo.issafe=="是">checked</#if>>&nbsp;&nbsp;是
        <input name="xzfyInfo.issafe" id="anquany_n"  value="否" onclick="setAqf(2)" type="radio" class="radio" <#if xzfyInfo.issafe=="否">checked</#if>>&nbsp;&nbsp;否
        <span id="aqspan"  <#if xzfyInfo.issafe=="否">style="display:none"<#/if>>
		  <a href="javascript:setAqf(1)">添加</a><br>
		  <textarea name="xzfyInfo.safeContent" type="text" class="textarea"  id="aqcontent" altname="安全隐患" style="width:300px;overflow-y:visible;" onchange="textCounter(this.form.comment,1000);">${xzfyInfo.safeContent?default('')}</textarea>
		</span>
    </td>
</tr>
   <tr >
	   ...
	   <th>申请人人数：</th>
    <td><input name="xzfyInfo.renCount" value="${xzfyInfo.rencount?default('')}" id="rencount" onBlur="renCount()" onchange="setCountAppname('shenqingren','rencount')"   type="text" class="inputTextNormal" altname="申请人人数"></td>
   </tr>
   <#--
    <tr  id="shenqingren1">
  	<th>申请人：</th>
   ...
   <tr  id="shenqingren1" <#if xzfyInfo.app_type=="2"> style="display:none"</#if>>
    ...
    <textarea name="xzfyInfo.appdetail" type="text" class="textarea" onchange="setCountAppname('shenqingren','rencount')" id="shenqingren" ischeck="y" altname="申请人" style="overflow-y:visible;"  >${xzfyInfo.appdetail?default('')}</textarea>
    </td>
   </tr>
   <tr class="trwhite" id="sqr" <#if xzfyInfo.app_type=="1"> style="display:none"</#if>>
    ...
    <textarea name="xzfyInfo.agentDetail" type="text" id="appname" class="textarea" ischeck="y" altname="法人" style="overflow-y:visible;" >${xzfyInfo.agentDetail?default('')}</textarea>
    </td>
   </tr>
  ...
  -->
   ...
   <tr id="jddlr" <#if xzfyInfo.agent=="0">style="display:none"</#if>>
    <th>委托代理人姓名：</th>
    <td>
    <input name="xzfyInfo.agent_name" type="text" id="dlrname"
    class="inputTextNormal" altname="委托代理人姓名项" value="${xzfyInfo.agent_name?default('')}"></td>
    <th>是否有授权委托书：</th>
    <td>
   ...
   <tr class="trwhite" id="jddlr1" <#if xzfyInfo.proxy!="3"> style="display:none"</#if> >
    <th>委托时间：</th>
    <td>
    ...
    <input name="xzfyInfo.agent_date" type="hidden" id="wtsj" value="${xzfyInfo.agent_date?default('')}"></td>
    <th>地点：</th>
    <td>
...
<tr >
   ...
   <@ww.select name="'xzfyInfo.defendant_type'" id="beapptype"  headerKey="'0'" headerValue="'--请选择--'"  list="getDictMap('bsqrzl')" 
    onchange="'aaa()'" value="'${xzfyInfo.defendant_type?default('')}'.toString()"/>
  ...
  <tr  id="mingan">
    <th>是否行政不作为：</th>
    <td>
    <@ww.select  name="'xzfyInfo.ismanage'"  id="requestrrr"  list="getDictMap('sfbzw')" value="'${xzfyInfo.ismanage?default('')}'.toString()" onchange="'szfyqq()'"/>
	</td>
     <th>要求复议的具体行政行为情况：</th>
	    <td>
  ...
  <textarea class="textarea" name="xzfyInfo.matter_detail" id="bzwbc" style="width:300px;overflow-y:visible;"></textarea>
	    ...
	    <td>申请人曾经要求被申请人<br>履行何种法定职责：</td>
	    <td  ><textarea name="xzfyInfo.duty" id="zhize" type="text" class="textarea"  style="width:300px;overflow-y:visible;"></textarea>
	    </td>
	    </tr>    
...
<td id="tdep">
<table  id="dep"><tr><td>
<select name="depsqr" id="deputySqr" isUser="true" retSelect="1" onchange="depChange()">
</select>
<#--
<input name="depsqr" isUser="true" size='6' value=""/>-->
</td>
<td>
	性别：
	<input name="depsex" id="depsex1" isUser="true"  value="" size=2/>
	</td>
	<td>
	身份证号：<input name="depnum" id="depnum1" isUser="true" value="" size=12/>
	</td>
	<td>
	送达地址：<input name="depaddress" id="depaddress1" isUser="true" value="" size=10/>
	</td>
	<td>
	邮编：<input name="deppost" id="deppost1" isUser="true" value="" size=4/>
	</td>
	<td>
	电话：<input name="depphone" id="depphone1" isUser="true" value='' size=8/>
...
var url="http://localhost:8080/webIscp/bac_document_edit.jsp?action=new&d_filetype=doc&d_templateid=20131014160005&d_username=${Session['_USER_LOGIN_'].id}&caseId=${xzfyId}";
...
var url="http://localhost:8080/webIscp/bac_document_edit.jsp?action=new&d_filetype=doc&d_templateid=20131014150926&d_username=${Session['_USER_LOGIN_'].id}&caseId=${xzfyId}";
	window.open(url,'mainwindow','location=no,resizable=yes');
}
