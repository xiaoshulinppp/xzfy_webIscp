...
function luru(aa){
	...
	listForm_= document.getElementById("form1");
		listForm_.action="../gjcx/anjiancx.action?funcCode=${funcCode}&&xzfyId_w=" + aa;
...
<!--wal-->
 ...
 <div class="formTitle2">请填写复议申请信息</div>
  ...
  <tr >
    ...
    <td><input class="input2" ischeck="y" altname="申请人人数"  name="xzfyInfo.renCount" id="rencount" onBlur="renCount();" onchange="setCountAppname('shenqingren','rencount');countNum('rencount')"   type="text"  altname="申请人人数"  value="${xzfyInfo_w.break_right}-${xzfyInfo_w.admit1}"/></td>
   </tr>
   <#--
    <tr  id="shenqingren1">
...
<div border="0" >
	<div class="btn" >
	<div class="fl" >
		<a href="#" title="请确认接待笔录无误，并由申请人在笔录所有页签字后，再点击提交。一旦提交，接待信息将无法修改。"  onclick="javascript:saveNew('${xzfyId_w}')">提交</a>
		<a href="#" title="返回"  onclick="javascript:back()">返回</a>
		
		<a href="#" title="返回"  onclick="javascript:luru('${xzfyId_w}')">案件录入</a>
