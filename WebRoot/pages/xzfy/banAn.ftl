...
<table width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="tabout">
  ...
  <tr class="trcolor">
    ...
    <td class="tdFormInput">
    <@ww.select  name="'xzfyInfo.trailmode'" id="slfsid" headerKey="''" headerValue=""  list="getDictMap('slfs')" value="" onchange="'slfs()'"/>
    <#--
  ...
  <tr class="trcolor">
    ...
    <td class="tdFormInput"><input name="xzfyInfo.secondSubmitResult" id="secondsubmitresult" type="text" class="inputTextNormal" value=""></td>
    <td class="tdFormText">承办人提交时间：</td>
    <td class="tdFormInput"><input name="xzfyInfo.secondSubmitDate" id="secondsubmitdate" type="text" onClick="WdatePicker()" class="inputTextNormal" title="请输入正确的姓名，格式在20个汉字以内" value="">
    </td>
  </tr>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabMainBot">
  <tr>
    <td> 
	   <input name="Button23" type="button" class="button" value="办 案"  onclick="saveNew('${xzfyInfo.id}')">
	   <input name="Button23" type="button" class="button" value="办案审批"  onclick="">
...
function saveNew(id){ 
	...
	alert(id);
	listForm_= document.getElementById("form1");
	listForm_.action="banAn.action?funcCode=${funcCode}&&xzfyId="+id;
	if(confirm("您确认保存吗?"))
	listForm_.submit();
}
