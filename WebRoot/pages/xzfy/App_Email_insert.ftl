...
<input name="xzfyInfo.count_year" type="hidden" class="inputTextNormal" ischeck="y" value=${countYear}>
  ...
  <tr class="trwhite">
   ...
   <tr  id="shenqingren1">
  	<th >申请人：</th>
    <td  colspan=3>
    <a href="javascript:setApp('#appDiv',3)" style="display:block" id="appspan">添加</a>
   ...
   <tr class="trwhite" id="sqr" style="display:none">
    <th>申请人名称：</th>
    <td colspan=3>
	<a href="javascript:setFr('#frDiv',3)" id="frspan" >添加</a><br>
   ...
   <tr id="daibiaorendiv" style="display:none"> 
	<th>代表人：</th>
	<td  colspan=3>
		    <a href="javascript:setDeputy('#deputyDiv',3)" style="display:block" id="deputyspan">添加</a>
