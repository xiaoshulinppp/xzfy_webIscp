...
<!--wal-->
 ...
 <div class="formTitle2">来信接收复议申请</div>
    ...
    id="user" ischeck="y" altname="来信人姓名" value="${xzfyInfo.laixin_name?default('')}">
  ...
  <tr class="trwhite">
    <th >来信人通信地址：</th>
	    <td >
	    <input name="xzfyInfo.laixin_address" type="text" id="dlr1" class="input2" title="请输入正确的姓名，格式在50个汉字以内" value="${xzfyInfo.laixin_address?default('')}"></td>
	    </td>
    <th >来信人邮编：</th>
    <td ><input name="xzfyInfo.laixin_post" type="text" id="handlesecond" ischeck="y" class="input2" altname="邮编" value="${xzfyInfo.laixin_post?default('')}"></td>
    </tr>
  <tr class="trwhite">
    <th >来文编号：</th>
    <td ><input name="xzfyInfo.zhize" type="text" id="zhize" class="input2" altname="来文编号" value="${xzfyInfo.zhize?default('')}"></td>
    <th >来信人电话：</th>
    <td ><input name="xzfyInfo.laixin_tel" type="text" id="phone" ischeck="y" class="input2" altname="被接待人电话" value="${xzfyInfo.laixin_tel?default('')}"></td>
  ...
  <tr class="trwhite">
    ...
    <td><input name="xzfyInfo.renCount" id="rencount" onBlur="renCount()" onchange="setCountAppname('shenqingren','rencount')"   type="text" class="input2" altname="申请人人数" value="${xzfyInfo.renCount?default('')}"></td>
   </tr>
   <tr  id="shenqingren1" <#if xzfyInfo.app_type=="2">style="display:none"</#if>>
    ...
    <textarea name="xzfyInfo.appdetail" readonly type="text" class="textarea" onchange="setCountAppname('shenqingren','rencount')" id="shenqingren" ischeck="y" altname="申请人" style="overflow-y:visible;"  >${xzfyInfo.appdetail?default('')}</textarea>
    </td>
   </tr>
   <tr class="trwhite" id="sqr" <#if xzfyInfo.app_type=="1">style="display:none"</#if>>
    ...
    <textarea name="xzfyInfo.agentDetail" type="text" id="appname" class="textarea" ischeck="y" altname="法人" style="overflow-y:visible;" readonly>${xzfyInfo.agentDetail?default('')}</textarea>
    </td>
   </tr>
   ...
   <tr id="daibiaorendiv" <#if !xzfyInfo.dbrDetail?has_content>style="display:none"</#if>> 
	...
	<td  colspan=3>
		...
		-->
    	<textarea name="xzfyInfo.dbrDetail" type="text" readonly class="textarea"  id="deputy" ischeck="y" altname="代表人" style="overflow-y:visible;">${xzfyInfo.dbrDetail?default('')}</textarea>
	</td>	    
   </tr>
  <tr >
    <th >代理人：</th>
	<td ><input name="xzfyInfo.agent_name"  type="text" class="input2" altname="代理人" maxlength="50" value="${xzfyInfo.agent_name?default('')}"></td>
	<th >&nbsp;</th>
	<td >&nbsp;</td>
   </tr>	
   <tr  id="jddlr2">
    <th >第三人：</th>
    <td ><input name="xzfyInfo.third" id="dsdlr1" type="text" class="input2"  altname="第三人" maxlength="50" value="${xzfyInfo.third?default('')}"></td>
	<th >第三人代理人：</th>
	<td ><input name="xzfyInfo.third_agent" type="text" class="input2"  altname="第三人代理人" maxlength="50" value="${xzfyInfo.third_agent?default('')}"></td>
   </tr>
  ...
  <tr >
   ...
   <tr id="jutixingwei" <#if xzfyInfo.ismanage?default('')=='2'>style="display:none"</#if>>
    <th >被复议的具体行为-名称：</th>
    <td ><input name="xzfyInfo.xwname" value="${xzfyInfo.xwname?default('')}" id="xingwei" type="text" ischeck="y" altname="被复议的具体行为-名称" class="input2" title="请输入正确的名称"></td>
     <th >被复议的具体行为-文号：</th>
    <td ><input name="xzfyInfo.xwnum" value="${xzfyInfo.xwnum?default('')}" type="text" id="annum" class="input2" ischeck="y" altname="文号"></td>
  </tr>
    ...
    <tr  id="mingan">
	    ...
	    <td>
	     <input name="xzfyInfo.ismanage" id="requestrrr_y" <#if xzfyInfo.ismanage?default('')=='2'>checked</#if> value="2" onclick="szfyqq(2)" type="radio" ><label for="requestrrr_y">是</label>
	        <input name="xzfyInfo.ismanage" id="requestrrr_n" <#if xzfyInfo.ismanage?default('')=='0'>checked</#if> value="0" onclick="szfyqq(0)" type="radio"  ><label for="requestrrr_n">否</label>
   ...
   <script>
    ...
    <td   colspan=3>
      <textarea name="xzfyInfo.xzfy_requset_retail" id="xzfyqq1" type="text"  class="textarea"   rowspan="5" altname="行政复议请求">${xzfyInfo.xzfy_requset_retail?default('')}</textarea></td>
    </tr>
	 ...
	 <tr >
	  <th >是否申请听证：</th>
	    <td >
	    	  <input type="radio" <#if xzfyInfo.istingzheng=="是">checked</#if> name="xzfyInfo.istingzheng" value="是" id="isting_y" ischeck="y" altname="是否听证">
		      <label for="isting_y">是</label>
		      <input type="radio" <#if xzfyInfo.istingzheng=="否">checked</#if> name="xzfyInfo.istingzheng" value="否" id="isting_n" ischeck="y" altname="是否听证">
		      <label for="isting_n">否</label>
	    </td>
	   <th >是否申请行政赔偿：</th>
  <td  >
   <input type="radio" <#if xzfyInfo.ismoney=="是">checked</#if> name="xzfyInfo.ismoney" value="是" id="peichangy" ischeck="y" altname="是否行政赔偿">
		      <label for="isting_y">是</label>
   <input type="radio" <#if xzfyInfo.ismoney=="否">checked</#if> name="xzfyInfo.ismoney" value="否" id="peichangn" ischeck="y" altname="是否行政赔偿" >
		      <label for="isting_n">否</label>
  </td>
    </tr>
	<tr >
		<th >复议前置：</th>
	    <td >
		    <input type="radio" name="xzfyInfo.isfront" value="是" id="fyqz_y" ischeck="y" altname="复议前置" <#if xzfyInfo.isfront=="是">checked</#if>>
		        <label for="fyqz_y">是 </label>
		     <input type="radio" name="xzfyInfo.isfront" value="否" id="fyqz_n" ischeck="y" altname="复议前置" <#if xzfyInfo.isfront=="否">checked</#if>>
	    ...
	    <td ><input type="radio" name="xzfyInfo.ischeck" nbzcheck="y" altname="对规范性文件审查" value="是" id="gfsc_y" onclick="check_shencha('1')" <#if xzfyInfo.ischeck=="是">checked</#if>>
	        ...
	        <input type="radio" name="xzfyInfo.ischeck" altname="对规范性文件审查" value="否" nbzcheck="y"  id="gfsc_n" onclick="check_shencha('2')" <#if xzfyInfo.ischeck=="否">checked</#if>>
	        <label for="gfsc_n">否</label>
		<span id="shencha" style="display:none">规范文件：
	   <textarea name="xzfyInfo.check_file"  id="post2" class="textarea">${xzfyInfo.check_file?default('')}</textarea>
	   </span>
	    </td>
	</tr>
	<!--
...
<tr>
<th>申请人：</th>
<td><input name="appsqr" onchange="checkComma(this)" isUser="true" value="${app.app_name?default('')}"/></td>
<th>性别：</th>
...
<tr>
	<th>身份证号：</th>
	<td><input name="appnum" onchange="checkComma(this)" isUser="true" value="${app.app_id?default('')}" />
	</td>
	<th>
	送达地址：
	</th>
	<td>
	<textarea name="appaddress" onchange="checkComma(this)" type="text" isUser="true">${app.mail_address?default('')}</textarea>
	</td>
</tr>
<tr>
	<th>
