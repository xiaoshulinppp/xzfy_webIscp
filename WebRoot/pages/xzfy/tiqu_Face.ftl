...
<input type="hidden" id="require_fy" name="xzfyInfo.require_fy" value="${xzfyInfo.require_fy?default('')}">
<input type="hidden" id="buzheng_from" name="xzfyInfo.buzheng_from" value="${xzfyInfo.buzheng_from?default('')}"> 
<input type="hidden" id="sljg" name="sljg" value="${xzfyInfo.caseorg?default('')}"> 
...
<!--wal-->
 ...
 <div class="formTitle2">当面接收复议申请</div>
  ...
  <tr >
    ...
    <td><input class="input2" ischeck="y" altname="申请人人数"  name="xzfyInfo.renCount" id="rencount" onBlur="renCount()"   type="text"  altname="申请人人数" value="${xzfyInfo.renCount?default('')}"></td>
   </tr>
   ...
   <tr  id="shenqingren1" <#if xzfyInfo.app_type=="2">style="display:none"</#if>>
    ...
    <textarea name="xzfyInfo.appdetail" type="text" style="border:0px"  class="textarea" readonly onchange="setCountAppname('shenqingren','rencount')" id="shenqingren" ischeck="y" altname="申请人" style="overflow-y:visible;" readonly>${xzfyInfo.appdetail?default('')}</textarea>
    </td>
   </tr>
 ...
 <input type="hidden" id="tiqu" value="1">
   <tr id="daibiaorendiv" <#if !xzfyInfo.dbrDetail?has_content>style="display:none"</#if>> 
	...
	<td  colspan=3>
    	...
    	<textarea name="xzfyInfo.dbrDetail" type="text" class="textarea"  id="deputy" ischeck="y" altname="代表人" style="overflow-y:visible;" readonly>${xzfyInfo.dbrDetail?default('')}</textarea>
	</td>	    
   </tr>
  ...
  <tr >
   <th><font color="red">*</font>是否有代理人：</th>
    <td>
     ...
     <input type="hidden" id="isdlr" value="${xzfyInfo.agent?default('0')}">
    </td>
...
<select class="selectStyleNormal" retSelect="1">
  ...
  <tr >
	...
	<th>其他复议机关、法院是否受理同一复议申请：</td>
     <td>
    <input type="radio" name="xzfyInfo.issame"  value="是" <#if xzfyInfo.issame?default('否')=="是">checked</#if>  id="isshouli_y" onclick="check_qtfyjg('1')">
	        <label for="isshouli_y">是 </label>
	<input type="radio" name="xzfyInfo.issame"  value="否"  <#if xzfyInfo.issame?default('否')=="否">checked</#if> id="isshouli_n" onclick="check_qtfyjg('0')">
...
<a href="javascript:updateFile()" style="display:block" id="filespan">接收材料</a>
 ...
 <textarea name="xzfyInfo.jdFileContent" id="filedetail" type="text" class='textarea' style="overflow-y:visible;display:block">${xzfyInfo.jdFileContent?default('')}</textarea>
...
<table  id="xwapp">
	<tr>
		...
		<td>
		<input name="xzfyInfo.xwname" isUser="true" size='60' value="${xw.xwName?default('')}" />
		</td>
	</tr>
	<tr>
		<th>被复议的具体行为-文号：</th>
		<td>
			<input name="xzfyInfo.xwnum" isUser="true" size='50'  value='${xw.xwNum?default('')}'  />&nbsp;<!--<a href="#" onclick="anNumConfirm();return false;" title="检测重复"  >检测重复</a>-->
		</td>
	</tr>
...
申请人：</th>
<td colspan=3>
<input name="frsqr" isUser="true" size="50" onchange="checkComma(this)" value="${app.app_name?default('')}"/>
</td>
</tr>
<tr>
<th>
...
<td width="32%"><input name="fuzeren" isUser="true" onchange="checkComma(this)" value="${app.deputyName?default('')}"/>
</td>
...
<th width="18%">
	送达地址：</th>
<td width="32%">
<textarea name="fzraddress" isUser="true" onchange="checkComma(this)" >${app.mail_address?default('')}</textarea>
<!--<input name="fzraddress" isUser="true" value="" size=30/>-->
	</td>	
	<th>
	邮编：</th>
<td><input name="fzrpost" isUser="true" onchange="checkComma(this)" value="${app.postcode?default('')}"/>
	</td>
	</tr>
	<tr>
	...
	<th>
	电话：</th>
<td><input name="fzrtele" isUser="true" onchange="checkComma(this)" value="${app.telephone?default('')}"/>
	</td>
</tr>
<tr>
<th>
...
<td><select name="appsex" isUser="true" retSelect="1" style="display:block">
	<option value="男" <#if app.sexy=="男">selected</#if>>男</option>
	<option value="女" <#if app.sexy=="女">selected</#if>>女</option>
	</select></td>
	</tr>
<tr>
	<th>身份证号：</th>
...
<tr>
	...
	<td><input name="apppost" isUser="true" onchange="checkComma(this)" value="${app.postcode?default('')}"/>
	</td>
	<th>
	电话：
	</th>
	<td><input name="appphone" isUser="true" onchange="checkComma(this)" value="${app.telephone?default('')}" />
...
<tr>
<th>申请人：</th>
<td><input name="appsqr" isUser="true" onchange="checkComma(this)" value=""/></td>
<th>性别：</th>
<td><select name="appsex" isUser="true" retSelect="1" style="display:block">
...
<tr>
	<th>身份证号：</th>
	<td><input name="appnum" isUser="true" onchange="checkComma(this)" value="" />
	</td>
	<th>
	送达地址：
	</th>
	<td>
	<textarea name="appaddress" type="text" onchange="checkComma(this)" isUser="true"></textarea>
	</td>
</tr>
<tr>
	<th>
	...
	<td><input name="appphone" isUser="true" onchange="checkComma(this)" value='' />
	<a href="#" onclick="deleteApp(this);return false;" title="删除"  >删除</a>
	</td>
</tr>
</table>
...
<table   id="dep" style="width:600px;">
	<tr style="width:600px;">
		...
		<td id="xuandbr">
			<#list xzfyInfo.xzfyApps as app>
			${app.app_name}&nbsp;&nbsp;<input type='checkbox' name='depsqr' id='deputySqr' value="${app.app_name}" <#if app.isdeputy=="1">checked</#if>/>
			</#list>
		</td>
	</tr>
</table>
...
function callbackfun1(){
	var url ="../fzb_default_dafutongzhi.jsp?&d_filetype=doc&d_username=${Session['_USER_LOGIN_'].id}&caseId=${xzfyNewId}&mstype=shouju";
...
function callbackfun2(){
	var url ="../fzb_default_dafutongzhi.jsp?&d_filetype=doc&d_username=${Session['_USER_LOGIN_'].id}&caseId=${xzfyNewId}&mstype=jiedaibilu";
