...
//alert("12332");
       var aa=document.getElementById("anjianma").value;
		...
		listForm_.action="../gjcx/anjiancx.action?funcCode=${funcCode}&&&name1=1&&g_caseorg=${localBm}&&w_queryType=1";
 ...
 <div class="formTitle2">当面接收复议申请</div>
  ...
  <tr >
   ...
   <tr class="trwhite" id="sqr" style="display:none">
    ...
    <textarea name="xzfyInfo.agentDetail" type="text" id="appname1" style="border:0px"  class="textarea" altname="法人" style="overflow-y:visible;" readonly></textarea>
    </td>
   </tr>		
		<tr >
