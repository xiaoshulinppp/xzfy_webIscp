      ...
      <div class="pageBox">
            ...
            <div class="pageNum">
               第${pNum}/${totalPage}页   共${totalCount}条
				...
				<a href="../xzfy/showXw1.action?pNum=1&funcCode=${funcCode}&listkeyword=${listkeyword}&xwName=${xwName}&dname=${dname}"; class="ui-page-item ui-page-item-first">首页</a>
			    <a href="../xzfy/showXw1.action?pNum=${upPage}&funcCode=${funcCode}&listkeyword=${listkeyword}&xwName=${xwName}&dname=${dname}"; class="ui-page-item ui-page-item-prev">上一页</a>
		     	<a href="../xzfy/showXw1.action?pNum=${downPage}&funcCode=${funcCode}&listkeyword=${listkeyword}&xwName=${xwName}&dname=${dname}"; class="ui-page-item ui-page-next">下一页</a>
			    <a href="../xzfy/showXw1.action?pNum=${totalPage}&funcCode=${funcCode}&listkeyword=${listkeyword}&xwName=${xwName}&dname=${dname}"; class="ui-page-item ui-page-last">尾页</a>　
...
<script>
		...
		function gotoPage(){
				...
				if(inputPage > ${totalPage}){
					...
					window.location = "../xzfy/showXw1.action?funcCode=${funcCode}&pNum=" + inputPage + "&listkeyword=${listkeyword}&xwName="+encodeURI(${xwName})+"&dname="+encodeURI(${dname});
				}
				return;
			}
