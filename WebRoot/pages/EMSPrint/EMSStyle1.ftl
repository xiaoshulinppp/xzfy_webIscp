...
<style>
	...
	.fl{float:left;}
	.fr{float:right;}
	.fra{display:block; width:77px; height:27px; line-height:27px; font-weight:bold; text-align:center; border:#eeeded solid 1px; margin-right:400px; float:right;}
	.btn{display:block; width:260px; height:27px;}
</style>
<title>邮单套打（国内EMS）</title>
</head>
<body style="background-image:url(../images/ems-img2.png);background-repeat:no-repeat;">
...
<input type="text" style="width:35%;height:20px" name="receiverAddress" id="receiverAddress" value="${receiverAddress?default('')}"/>
		...
		<select style="float:right" onchange="changeReceiverAddressDetail(this.value)">
...
<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="text" style="width:34.5%;height:20px" name="senderAddress" id="senderAddress"  value="${senderAddress}" />
<br/>
<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;
<input type="text" style="width:34.5%;height:45px" name="mailDescription" id="mailDescription" value=""/>
<br/>
<br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<script>
	...
	//  LODOP.PRINT_INITA(0,0,800,1107,"");
	    ...
	    LODOP.ADD_PRINT_SETUP_BKIMG("<img border='0' src='../images/ems-img2.png'>");
	...
	LODOP.ADD_PRINT_SETUP_BKIMG("<img border='0' src='../images/ems-img2.png'>");
	LODOP.SET_SHOW_MODE("BKIMG_WIDTH",1321);
	LODOP.SET_SHOW_MODE("BKIMG_HEIGHT",681);
	LODOP.SET_SHOW_MODE("BKIMG_IN_PREVIEW",true);
	LODOP.SET_SHOW_MODE("BKIMG_PRINT",true);
	LODOP.ADD_PRINT_TEXT(232,205,376,27,senderFirm);
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",12);
	LODOP.ADD_PRINT_TEXT(192,417,190,26,senderPhone);
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",12);
	LODOP.ADD_PRINT_TEXT(198,193,131,25,sender);
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",12);
	LODOP.ADD_PRINT_TEXT(164,710,455,29,receiver);
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",12);
	LODOP.ADD_PRINT_TEXT(333,189,100,27,senderPostcode);
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",12);
	LODOP.ADD_PRINT_TEXT(258,573,621,27,receiverAddress);
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",12);
	
	if(recFirm !=null && recFirm !=''){
		LODOP.ADD_PRINT_TEXT(191,719,455,25,receiverFirm);
	}
		
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",12);
	LODOP.ADD_PRINT_TEXT(527,149,657,25,mailDescription);
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",12);
	LODOP.ADD_PRINT_TEXT(296,151,472,27,senderAddress);
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",12);
	*/	
	
	LODOP.PRINT_INITA(30,31,1300,675,"");
	LODOP.ADD_PRINT_SETUP_BKIMG("<img border='0' src='../images/ems-img2.png'>");
	LODOP.SET_SHOW_MODE("BKIMG_WIDTH",1321);
	LODOP.SET_SHOW_MODE("BKIMG_HEIGHT",681);
	LODOP.SET_SHOW_MODE("BKIMG_IN_PREVIEW",true);
	LODOP.SET_SHOW_MODE("BKIMG_PRINT",true);
	LODOP.ADD_PRINT_TEXT(229,240,471,27,senderFirm);
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",18);
	LODOP.ADD_PRINT_TEXT(190,474,190,26,senderPhone);
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",18);
	LODOP.ADD_PRINT_TEXT(193,238,131,25,sender);
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",18);
	LODOP.ADD_PRINT_TEXT(156,787,508,29,receiver);
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",18);
	LODOP.ADD_PRINT_TEXT(341,219,100,27,senderPostcode);
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",18);
	LODOP.ADD_PRINT_TEXT(241,717,557,111,receiverAddress);
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",18);
	
	
	if(recFirm !=null && recFirm !=''){	
		LODOP.ADD_PRINT_TEXT(190,814,479,25,receiverFirm);
		LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
		LODOP.SET_PRINT_STYLEA(0,"FontSize",18);
	}
	...
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",18);
	LODOP.ADD_PRINT_TEXT(559,183,990,25,mailDescription);
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",18);
	LODOP.ADD_PRINT_TEXT(304,217,502,27,senderAddress);
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",18);
	LODOP.ADD_PRINT_TEXT(155,459,162,24,systemDate);
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",18);
	LODOP.ADD_PRINT_TEXT(601,216,100,25,senderSign);
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",18);
	...
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",18);
	LODOP.ADD_PRINT_TEXT(235,744,557,111,receiverAddress);
	LODOP.SET_PRINT_STYLEA(0,"FontName","仿宋");
	LODOP.SET_PRINT_STYLEA(0,"FontSize",18);
