...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<input type="hidden" name="scheduleInfo.recorder" value="${scheduleInfo.recorder}">
		<input type="hidden" name="scheduleInfo.recorderId" value="${scheduleInfo.recorderId}">
		<input type="hidden" name="scheduleInfo.id" value="${scheduleInfo.id}">
...
<div class="ui-form fn-clear">
		<table width="100%" border="0" cellspacing="0" cellpadding="0"  class="ui-table ui-table-form ">
			<tr>
				<th>日期s</th>
				<td>
					<input type="text" name="scheduleInfo.scheduleDate" value="${scheduleInfo.scheduleDate}" onClick="WdatePicker();" class="inputTextNormal"/>
				</td>
				<th>标题</th>
				<td>
					<input type="text" name="scheduleInfo.title" value="${scheduleInfo.title}" class="inputTextNormal"/>
				</td>
			</tr>
			...
			<tr>
				<th width="12%">内容</th>
				<td colspan=3>
					<textarea name="scheduleInfo.content">${scheduleInfo.content?default('')}</textarea>
				</td>
