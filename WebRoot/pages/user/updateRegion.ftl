...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabMainBot">
  <tr>
   <td align="right">
     <input type="button" class="button" value="${action.getText("create.text")}" onclick = "window.location='../user/createRegion.action?funcCode=${funcCode}&&parentId=${entityId}&opName=create'">
     <input type="button" class="button" value="${action.getText("delete.text")}" onclick = "window.location='../user/deleteRegion.action?funcCode=${funcCode}&parentId=${entityId}&entityId=${entityId}&selectRecord=${entityId}&opName=delete'">
    </td>
  </tr>
</table>
