...
function AddOption(s_Id, s_Value, s_Text) {
	...
	<body onload="ChangeFileType()">
		<div id="bdy">
			...
			<div id="nav">
				您当前位置 &gt;&gt;
				<a href="bac_default_cailiaochulidan.jsp?caseId=<%=ms_cassid%>&d_username=<%=ms_userrName%>&d_checkstatus=<%=ms_checkstatus%>">首页</a>
			</div>
			<hr />
			...
			<table class="lst">
				...
				<tr>
					<td>
						<form name="form1" action="bac_document_cailiaochulidan_edit.jsp?action=new"
							method="post">
							用户名：
