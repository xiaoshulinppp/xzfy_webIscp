						...
						while (rs.next()) {
							...
							if (rs.getString("D_FileType").toLowerCase().equals("doc")
									|| rs.getString("D_FileType").toLowerCase().equals(
											"wps")) {
								s_Link = "<a href='fzb_document_dafutongzhi_edit.jsp?action=norevision&d_templateid="
										+ d_templateid
										+ "&d_username="
										+ ms_userrName
										+ "&d_recordid="
										...
										+ ms_cassid
										+ "'>修改无痕迹</a>"
										+ "→<a href='fzb_document_dafutongzhi_edit.jsp?action=yesrevision&d_templateid="
										+ d_templateid
										+ "&d_username="
										+ ms_userrName
										+ "&d_recordid="
										...
										+ ms_cassid
										+ "'>修改有痕迹</a>"
										+ "→<a href='fzb_document_dafutongzhi_edit.jsp?action=read&d_templateid="
										+ d_templateid
										+ "&d_username="
										+ ms_userrName
										+ "&d_recordid="
										...
										+ ms_cassid
										+ "'>阅读</a>"
										+ " <a style='color:red;' href='fzb_document_dafutongzhi_delete.jsp?d_recordid="
										+ rs.getString("D_RecordID")
										+ "&d_username="
										+ ms_userrName
										+ "&caseId="
								...
								s_Link = "<a href='fzb_document_dafutongzhi_edit.jsp?action=norevision&d_username="
										+ ms_userrName
										+ "&d_recordid="
										+ rs.getString("D_RecordID")
										+ "&caseId="
										...
										+ "→套红"
										+ "→签章"
										+ "→<a href='fzb_document_dafutongzhi_edit.jsp?action=read&d_username="
										+ ms_userrName
										+ "&d_recordid="
										+ rs.getString("D_RecordID")
										+ "&caseId="
