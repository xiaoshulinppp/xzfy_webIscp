...
xyTree.Node.prototype.innerhtml = function() {
  ...
  img.id = qj + 'imgfold' + this.xuhao; //做标记 2011-04-29 Kerbol
 ...
 * @type HTMLElement:img
 */
xyTree.Node.prototype.getHtmlElementFlodImg = function() {
	var dd = this.tree.objectname + xyTree.CONSTANT.treeFlodImgID + this.xuhao;
	return document.getElementById(dd);
}
