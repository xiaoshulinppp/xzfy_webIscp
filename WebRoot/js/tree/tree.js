...
function TreeNode(){
	...
	this.init = function(name,tg,tab,parent,value,hasLeaf){
		this.tg = tg;
		this.name = name;
		this.value = value;
	...
	this.addNode = function(name,value,hasLeaf){	  
		node = this.tg.createTreeNode(name,this.tab+1,this,value,hasLeaf);
...
function TreeGlobe(){
	...
	this.createTreeNode = function(name,tab,parent,value,hasLeaf){
		node = new TreeNode();
		node.init(name,this,tab,parent,value,hasLeaf);
