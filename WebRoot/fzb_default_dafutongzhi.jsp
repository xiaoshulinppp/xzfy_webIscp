...
response.setCharacterEncoding("UTF-8");
	...
	if(ms_type.equals("yingsupibandan"))
	{
		d_templateid = "20150520163306";//模板编号
	}
				...
				String s_alert;
					try {
						...
						while (rs.next()) {
							...
							if(ms_actiontype.equals("seal")){
								s_alert = "<script>window.location='fzb_document_dafutongzhi_edit.jsp?action=seal&caseId="+ms_cassid+"&d_username="+ms_userrName+"&d_recordid="+rs.getString("D_RecordID")+"&mstype="+ms_type+"&userrid="+userrid+"'</script>";
								closeAll(con, sttmt, rs);
							response.getWriter().write(s_alert);
							}
